		...
		<div class="article-text">
			...
			<?php 
				...
				<div class="entry-meta article-attr muted clearfix">
					...
					<?php /*------------------------ Author Block ------------------------*/ ?>
					<?php if ($params->get('show_author') && !empty($this->item->author ) && (int)$this->columns < 4 ): ?>
						<i class="icon-user"></i>
					...
					<?php if (($params->get('show_print_icon') || $params->get('show_email_icon') || $canEdit) && (int)$this->columns == 1) : ?>
