...
if(!function_exists('carousel_sc')) {
	...
	function carousel_sc( $atts, $content="" ){
		...
		$html .='<a class="carousel-control left" href="#' . $params['id'] . '" data-slide="prev"><i class="icon-angle-left"></i></a><a class="carousel-control right" href="#' . $params['id'] . '" data-slide="next"><i class="icon-angle-right"></i></a>';
