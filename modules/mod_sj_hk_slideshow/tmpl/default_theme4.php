...
<div class="sl-container"
	...
	foreach ($list as $item) {
		...
		<div class="sl-item "
		     ...
		     data-cycle-price="<?php $price = ($params->get('item_price_display', 1)) ? htmlentities($item->_price, ENT_QUOTES | ENT_IGNORE, "UTF-8") : '';
		     echo $price ?>"
...
<!--		     data-cycle-votes = "--><?php //echo htmlentities($minivotes , ENT_QUOTES | ENT_IGNORE, "UTF-8"); ?><!--"-->
			...
			<a href="<?php echo $item->link; ?>" title="<?php echo $item->title ?>"
				<?php echo HKSlideshowHelper::parseTarget($params->get('item_link_target')); ?> >
