...
<div class="sl-container"
	...
	foreach ($list as $item) {
		...
		$condition = ($show_desc == 0 && $show_title == 0 )||( $desc == '' && $item->title == "" && $minivotes == '' && $btn_add == '' );
		?>
		<div class="sl-item "
			 ...
			 data-cycle-price="<?php echo $item->_price; ?>"
			...
			<a href="<?php echo $item->link; ?>" title="<?php echo $item->title ?>" <?php echo HKSlideshowHelper::parseTarget($params->get('item_link_target')); ?> >
