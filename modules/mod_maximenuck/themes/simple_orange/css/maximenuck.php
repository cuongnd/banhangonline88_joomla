...
div#<?php echo $id; ?> ul.maximenuck {
    ...
    zoom:1;
	filter: none;
	background : #ff6200 url(../images/fond_bg.png) top left repeat-x;
    min-height : 34px;
}
...
div#<?php echo $id; ?> div.floatck {
	...
	padding : 0;
    margin : 0;
    background : #ff6200 url(../images/transparent.gif); /* important for hover to work good under IE7 */
...
div#<?php echo $id; ?> ul.maximenuck2 li span.separator {
    text-decoration : none;
    border-bottom : 1px solid #ffb07f;
    width : 96%;
    margin : 0 2%;
    padding : 3px 0 3px 0;
	display: block;
