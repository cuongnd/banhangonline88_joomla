...
div#<?php echo $id; ?> ul.maximenuck {
	...
	filter: none;
	background: #aaaaaa;
    background: -moz-linear-gradient(top,  #aaaaaa 0%, #848484 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#aaaaaa), color-stop(100%,#848484));
    background: -webkit-linear-gradient(top,  #aaaaaa 0%,#848484 100%);
    background: -o-linear-gradient(top,  #aaaaaa 0%,#848484 100%);
    background: -ms-linear-gradient(top,  #aaaaaa 0%,#848484 100%);
    background: linear-gradient(top,  #aaaaaa 0%,#848484 100%);
	font-family: Verdana;
	border-radius: 5px;
}
...
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1.active {
	background: #c5c5c5;
    background: -moz-linear-gradient(top,  #e3e3e3 0%, #c5c5c5 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#e3e3e3), color-stop(100%,#c5c5c5));
    background: -webkit-linear-gradient(top,  #e3e3e3 0%,#c5c5c5 100%);
    background: -o-linear-gradient(top,  #e3e3e3 0%,#c5c5c5 100%);
    background: -ms-linear-gradient(top,  #e3e3e3 0%,#c5c5c5 100%);
    background: linear-gradient(top,  #e3e3e3 0%,#c5c5c5 100%);
	border-radius: 5px;
