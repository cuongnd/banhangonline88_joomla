...
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1:hover > a,
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1:hover > span.separator,
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1.active > a,
...
div#<?php echo $id; ?>.maximenuckv ul.maximenuck li.level1.parent > span:after {
	content: "+";
	display: block;
	float: right;
	width: 0; 
