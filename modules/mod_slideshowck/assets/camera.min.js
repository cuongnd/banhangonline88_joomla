...
function imgFake(){$("iframe",fakeHover).each(function(){$(".camera_caption",fakeHover).show();var t=$(this);var cloneSrc=t.attr("data-src");t.attr("src",cloneSrc);var imgFakeUrl=opts.imagePath+"blank.gif";var imgFake=new Image;imgFake.src=imgFakeUrl;if(opts.height.indexOf("%")!=-1){var startH=Math.round(w/(100/parseFloat(opts.height)));if(opts.minHeight!=""&&startH<parseFloat(opts.minHeight))h=parseFloat(opts.minHeight);else h=startH}else if(opts.height=="auto")h=wrap.height();else h=parseFloat(opts.height);
t.after($(imgFake).attr({"class":"imgFake","width":w,"height":h}));var clone=t.clone();t.remove();$(imgFake).bind("click",function(){if($(this).css("position")=="absolute"){$(this).remove();if(cloneSrc.indexOf("vimeo")!=-1||cloneSrc.indexOf("youtube")!=-1)if(cloneSrc.indexOf("?")!=-1)autoplay="&autoplay=1";else autoplay="?autoplay=1";else if(cloneSrc.indexOf("dailymotion")!=-1)if(cloneSrc.indexOf("?")!=-1)autoplay="&autoPlay=1";else autoplay="?autoPlay=1";clone.attr("src",cloneSrc+autoplay);videoPresent=
true}else{$(this).css({position:"absolute",top:0,left:0,zIndex:10}).after(clone);clone.css({position:"absolute",top:0,left:0,zIndex:9})}})})}$.support.borderRadius=false;$.each(["borderRadius","BorderRadius","MozBorderRadius","WebkitBorderRadius","OBorderRadius","KhtmlBorderRadius"],function(){if(document.body.style[this]!==undefined)$.support.borderRadius=true});var opts=$.extend({},defaults,opts);var wrap=$(this).addClass("camera_wrap");wrap.wrapInner('<div class="camera_src" />').wrapInner('<div class="camera_fakehover" />');
var fakeHover=$(".camera_fakehover",wrap);var fakeHoverSelector=(".camera_fakehover",wrap);fakeHover.append('<div class="camera_target"></div>');if(opts.overlayer==true)fakeHover.append('<div class="camera_overlayer"></div>');fakeHover.append('<div class="camera_target_content"></div>');var loader;if(opts.loader=="pie"&&!$.support.borderRadius)loader="bar";else loader=opts.loader;if(loader=="pie")fakeHover.append('<div class="camera_pie"></div>');else if(loader=="bar")fakeHover.append('<div class="camera_bar"></div>');
else fakeHover.append('<div class="camera_bar" style="display:none"></div>');if(opts.playPause==true)fakeHover.append('<div class="camera_commands"></div>');if(opts.navigation==true)fakeHover.append('<div class="camera_prev"><span></span></div>').append('<div class="camera_next"><span></span></div>');if(opts.thumbnails==true)wrap.append('<div class="camera_thumbs_cont" />');if(opts.thumbnails==true&&opts.pagination!=true)$(".camera_thumbs_cont",wrap).wrap("<div />").wrap('<div class="camera_thumbs" />').wrap("<div />").wrap('<div class="camera_command_wrap" />');
if(opts.pagination==true)wrap.append('<div class="camera_pag"></div>');wrap.append('<div class="camera_loader"></div>');$(".camera_caption",wrap).each(function(){$(this).wrapInner("<div />")});var pieID="pie_"+wrap.index(),elem=$(".camera_src",wrap),target=$(".camera_target",wrap),content=$(".camera_target_content",wrap),pieContainer=$(".camera_pie",wrap),barContainer=$(".camera_bar",wrap),prevNav=$(".camera_prev",wrap),nextNav=$(".camera_next",wrap),commands=$(".camera_commands",wrap),pagination=
$(".camera_pag",wrap),thumbs=$(".camera_thumbs_cont",wrap);var w,h;var allImg=new Array;$("> div",elem).each(function(){allImg.push($(this).attr("data-src"))});var allLinks=new Array;$("> div",elem).each(function(){if($(this).attr("data-link"))allLinks.push($(this).attr("data-link"));else allLinks.push("")});var allTargets=new Array;$("> div",elem).each(function(){if($(this).attr("data-target"))allTargets.push($(this).attr("data-target"));else allTargets.push("")});var allPor=new Array;$("> div",
elem).each(function(){if($(this).attr("data-portrait"))allPor.push($(this).attr("data-portrait"));else allPor.push("")});var allAlign=new Array;$("> div",elem).each(function(){if($(this).attr("data-alignment"))allAlign.push($(this).attr("data-alignment"));else allAlign.push("")});var allThumbs=new Array;$("> div",elem).each(function(){if($(this).attr("data-thumb"))allThumbs.push($(this).attr("data-thumb"));else allThumbs.push("")});var amountSlide=allImg.length;$(content).append('<div class="cameraContents" />');
var loopMove;for(loopMove=0;loopMove<amountSlide;loopMove++){$(".cameraContents",content).append('<div class="cameraContent" />');if(allLinks[loopMove]!=""){var dataBox=$("> div ",elem).eq(loopMove).attr("data-box");if(typeof dataBox!=="undefined"&&dataBox!==false&&dataBox!="")dataBox='data-box="'+$("> div ",elem).eq(loopMove).attr("data-box")+'"';else dataBox="";$(".camera_target_content .cameraContent:eq("+loopMove+")",wrap).append('<a class="camera_link" href="'+allLinks[loopMove]+'" '+dataBox+
' target="'+allTargets[loopMove]+'"></a>')}}$(".camera_caption",wrap).each(function(){var ind=$(this).parent().index(),cont=wrap.find(".cameraContent").eq(ind);$(this).appendTo(cont)});target.append('<div class="cameraCont" />');var cameraCont=$(".cameraCont",wrap);var loop;for(loop=0;loop<amountSlide;loop++){cameraCont.append('<div class="cameraSlide cameraSlide_'+loop+'" />');var div=$("> div:eq("+loop+")",elem);target.find(".cameraSlide_"+loop).clone(div)}function thumbnailVisible(){var wTh=$(thumbs).width();
$("li",thumbs).removeClass("camera_visThumb");$("li",thumbs).each(function(){var pos=$(this).position(),ulW=$("ul",thumbs).outerWidth(),offUl=$("ul",thumbs).offset().left,offDiv=$("> div",thumbs).offset().left,ulLeft=offDiv-offUl;if(ulLeft>0)$(".camera_prevThumbs",camera_thumbs_wrap).removeClass("hideNav");else $(".camera_prevThumbs",camera_thumbs_wrap).addClass("hideNav");if(ulW-ulLeft>wTh)$(".camera_nextThumbs",camera_thumbs_wrap).removeClass("hideNav");else $(".camera_nextThumbs",camera_thumbs_wrap).addClass("hideNav");
var left=pos.left,right=pos.left+$(this).width();if(right-ulLeft<=wTh&&left-ulLeft>=0)$(this).addClass("camera_visThumb")})}$(window).bind("load resize pageshow",function(){thumbnailPos();thumbnailVisible()});cameraCont.append('<div class="cameraSlide cameraSlide_'+loop+'" />');var started;wrap.show();var w=target.width();var h=target.height();var setPause;$(window).bind("resize pageshow",function(){if(started==true)resizeImage();$("ul",thumbs).animate({"margin-top":0},0,thumbnailPos);if(!elem.hasClass("paused")){elem.addClass("paused");
if($(".camera_stop",camera_thumbs_wrap).length){$(".camera_stop",camera_thumbs_wrap).hide();$(".camera_play",camera_thumbs_wrap).show();if(loader!="none")$("#"+pieID).hide()}else if(loader!="none")$("#"+pieID).hide();clearTimeout(setPause);setPause=setTimeout(function(){elem.removeClass("paused");if($(".camera_play",camera_thumbs_wrap).length){$(".camera_play",camera_thumbs_wrap).hide();$(".camera_stop",camera_thumbs_wrap).show();if(loader!="none")$("#"+pieID).fadeIn()}else if(loader!="none")$("#"+
pieID).fadeIn()},1500)}});function resizeImage(){var res;function resizeImageWork(){w=wrap.width();if(opts.height.indexOf("%")!=-1){var startH=Math.round(w/(100/parseFloat(opts.height)));if(opts.minHeight!=""&&startH<parseFloat(opts.minHeight))h=parseFloat(opts.minHeight);else h=startH;wrap.css({height:h})}else if(opts.height=="auto")h=wrap.height();else{h=parseFloat(opts.height);wrap.css({height:h})}$(".camerarelative",target).css({"width":w,"height":h});$(".imgLoaded",target).each(function(){var t=
$(this),wT=t.attr("width"),hT=t.attr("height"),imgLoadIn=t.index(),mTop,mLeft,alignment=t.attr("data-alignment"),portrait=t.attr("data-portrait");if(typeof alignment==="undefined"||alignment===false||alignment==="")alignment=opts.alignment;if(typeof portrait==="undefined"||portrait===false||portrait==="")portrait=opts.portrait;if(portrait==false||portrait=="false")if(wT/hT<w/h){var r=w/wT;var d=Math.abs(h-hT*r)*.5;switch(alignment){case "topLeft":mTop=0;break;case "topCenter":mTop=0;break;case "topRight":mTop=
0;break;case "centerLeft":mTop="-"+d+"px";break;case "center":mTop="-"+d+"px";break;case "centerRight":mTop="-"+d+"px";break;case "bottomLeft":mTop="-"+d*2+"px";break;case "bottomCenter":mTop="-"+d*2+"px";break;case "bottomRight":mTop="-"+d*2+"px";break}t.css({"height":hT*r,"margin-left":0,"margin-right":0,"margin-top":mTop,"position":"absolute","visibility":"visible","width":w})}else{var r=h/hT;var d=Math.abs(w-wT*r)*.5;switch(alignment){case "topLeft":mLeft=0;break;case "topCenter":mLeft="-"+d+
"px";break;case "topRight":mLeft="-"+d*2+"px";break;case "centerLeft":mLeft=0;break;case "center":mLeft="-"+d+"px";break;case "centerRight":mLeft="-"+d*2+"px";break;case "bottomLeft":mLeft=0;break;case "bottomCenter":mLeft="-"+d+"px";break;case "bottomRight":mLeft="-"+d*2+"px";break}t.css({"height":h,"margin-left":mLeft,"margin-right":mLeft,"margin-top":0,"position":"absolute","visibility":"visible","width":wT*r})}else if(wT/hT<w/h){var r=h/hT;var d=Math.abs(w-wT*r)*.5;switch(alignment){case "topLeft":mLeft=
0;break;case "topCenter":mLeft=d+"px";break;case "topRight":mLeft=d*2+"px";break;case "centerLeft":mLeft=0;break;case "center":mLeft=d+"px";break;case "centerRight":mLeft=d*2+"px";break;case "bottomLeft":mLeft=0;break;case "bottomCenter":mLeft=d+"px";break;case "bottomRight":mLeft=d*2+"px";break}t.css({"height":h,"margin-left":mLeft,"margin-right":mLeft,"margin-top":0,"position":"absolute","visibility":"visible","width":wT*r})}else{var r=w/wT;var d=Math.abs(h-hT*r)*.5;switch(alignment){case "topLeft":mTop=
...
started=true}var u,setT;var clickEv,autoAdv,navHover,commands,pagination;var videoHover,videoPresent;if(isMobile()&&opts.mobileAutoAdvance!="")autoAdv=opts.mobileAutoAdvance;else autoAdv=opts.autoAdvance;if(autoAdv==false)elem.addClass("paused");if(isMobile()&&opts.mobileNavHover!="")navHover=opts.mobileNavHover;else navHover=opts.navigationHover;if(elem.length!=0){var selector=$(".cameraSlide",target);selector.wrapInner('<div class="camerarelative" />');var navSlide;var barDirection=opts.barDirection;
var camera_thumbs_wrap=wrap;$("iframe",fakeHover).each(function(){var t=$(this);var src=t.attr("src");t.attr("data-src",src);var divInd=t.parent().index(".camera_src > div");$(".camera_target_content .cameraContent:eq("+divInd+")",wrap).append(t)});imgFake();if(opts.hover==true)if(!isMobile())fakeHover.hover(function(){elem.addClass("hovered")},function(){elem.removeClass("hovered")});if(navHover==true){$(prevNav,wrap).animate({opacity:0},0);$(nextNav,wrap).animate({opacity:0},0);$(commands,wrap).animate({opacity:0},
0);if(isMobile()){$(document).on("vmouseover",fakeHoverSelector,function(){$(prevNav,wrap).animate({opacity:1},200);$(nextNav,wrap).animate({opacity:1},200);$(commands,wrap).animate({opacity:1},200)});$(document).on("vmouseout",fakeHoverSelector,function(){$(prevNav,wrap).delay(500).animate({opacity:0},200);$(nextNav,wrap).delay(500).animate({opacity:0},200);$(commands,wrap).delay(500).animate({opacity:0},200)})}else fakeHover.hover(function(){$(prevNav,wrap).animate({opacity:1},200);$(nextNav,wrap).animate({opacity:1},
200);$(commands,wrap).animate({opacity:1},200)},function(){$(prevNav,wrap).animate({opacity:0},200);$(nextNav,wrap).animate({opacity:0},200);$(commands,wrap).animate({opacity:0},200)})}camera_thumbs_wrap.on("click",".camera_stop",function(){autoAdv=false;elem.addClass("paused");if($(".camera_stop",camera_thumbs_wrap).length){$(".camera_stop",camera_thumbs_wrap).hide();$(".camera_play",camera_thumbs_wrap).show();if(loader!="none")$("#"+pieID).hide()}else if(loader!="none")$("#"+pieID).hide()});camera_thumbs_wrap.on("click",
".camera_play",function(){autoAdv=true;elem.removeClass("paused");if($(".camera_play",camera_thumbs_wrap).length){$(".camera_play",camera_thumbs_wrap).hide();$(".camera_stop",camera_thumbs_wrap).show();if(loader!="none")$("#"+pieID).show()}else if(loader!="none")$("#"+pieID).show()});if(opts.pauseOnClick==true)$(".camera_target_content",fakeHover).mouseup(function(){autoAdv=false;elem.addClass("paused");$(".camera_stop",camera_thumbs_wrap).hide();$(".camera_play",camera_thumbs_wrap).show();$("#"+
pieID).hide()});$(".cameraContent, .imgFake",fakeHover).hover(function(){videoHover=true},function(){videoHover=false});$(".cameraContent, .imgFake",fakeHover).bind("click",function(){if(videoPresent==true&&videoHover==true){autoAdv=false;$(".camera_caption",fakeHover).hide();elem.addClass("paused");$(".camera_stop",camera_thumbs_wrap).hide();$(".camera_play",camera_thumbs_wrap).show();$("#"+pieID).hide()}})}function shuffle(arr){for(var j,x,i=arr.length;i;j=parseInt(Math.random()*i),x=arr[--i],arr[i]=
arr[j],arr[j]=x);return arr}function isInteger(s){return Math.ceil(s)==Math.floor(s)}if(loader!="pie"){barContainer.append('<span class="camera_bar_cont" />');$(".camera_bar_cont",barContainer).animate({opacity:opts.loaderOpacity},0).css({"position":"absolute","left":0,"right":0,"top":0,"bottom":0,"background-color":opts.loaderBgColor}).append('<span id="'+pieID+'" />');$("#"+pieID).animate({opacity:0},0);var canvas=$("#"+pieID);canvas.css({"position":"absolute","background-color":opts.loaderColor});
switch(opts.barPosition){case "left":barContainer.css({right:"auto",width:opts.loaderStroke});break;case "right":barContainer.css({left:"auto",width:opts.loaderStroke});break;case "top":barContainer.css({bottom:"auto",height:opts.loaderStroke});break;case "bottom":barContainer.css({top:"auto",height:opts.loaderStroke});break}switch(barDirection){case "leftToRight":canvas.css({"left":0,"right":0,"top":opts.loaderPadding,"bottom":opts.loaderPadding});break;case "rightToLeft":canvas.css({"left":0,"right":0,
"top":opts.loaderPadding,"bottom":opts.loaderPadding});break;case "topToBottom":canvas.css({"left":opts.loaderPadding,"right":opts.loaderPadding,"top":0,"bottom":0});break;case "bottomToTop":canvas.css({"left":opts.loaderPadding,"right":opts.loaderPadding,"top":0,"bottom":0});break}}else{pieContainer.append('<canvas id="'+pieID+'"></canvas>');var G_vmlCanvasManager;var canvas=document.getElementById(pieID);canvas.setAttribute("width",opts.pieDiameter);canvas.setAttribute("height",opts.pieDiameter);
...
false){$("#"+pieID).hide();$(".camera_canvas_wrap",camera_thumbs_wrap).hide()}if($(pagination).length){$(pagination).append('<ul class="camera_pag_ul" />');var li;for(li=0;li<amountSlide;li++)$(".camera_pag_ul",wrap).append('<li class="pag_nav_'+li+'" style="position:relative; z-index:1002"><span><span>'+li+"</span></span></li>");$(".camera_pag_ul li",wrap).hover(function(){$(this).addClass("camera_hover");if($(".camera_thumb",this).length){var wTh=$(".camera_thumb",this).outerWidth(),hTh=$(".camera_thumb",
this).outerHeight(),wTt=$(this).outerWidth();$(".camera_thumb",this).show().css({"top":"-"+hTh+"px","left":"-"+(wTh-wTt)/2+"px"}).animate({"opacity":1,"margin-top":"-3px"},200);$(".thumb_arrow",this).show().animate({"opacity":1,"margin-top":"-3px"},200)}},function(){$(this).removeClass("camera_hover");$(".camera_thumb",this).animate({"margin-top":"-20px","opacity":0},200,function(){$(this).css({marginTop:"5px"}).hide()});$(".thumb_arrow",this).animate({"margin-top":"-20px","opacity":0},200,function(){$(this).css({marginTop:"5px"}).hide()})})}if($(thumbs).length){var thumbUrl;
if(!$(pagination).length){$(thumbs).append("<div />");$(thumbs).before('<div class="camera_prevThumbs hideNav"><div></div></div>').before('<div class="camera_nextThumbs hideNav"><div></div></div>');$("> div",thumbs).append("<ul />");$.each(allThumbs,function(i,val){if($("> div",elem).eq(i).attr("data-thumb")!=""){var thumbUrl=$("> div",elem).eq(i).attr("data-thumb"),newImg=new Image;newImg.src=thumbUrl;$("ul",thumbs).append('<li class="pix_thumb pix_thumb_'+i+'" />');$("li.pix_thumb_"+i,thumbs).append($(newImg).attr("class",
"camera_thumb"))}})}else{$.each(allThumbs,function(i,val){if($("> div",elem).eq(i).attr("data-thumb")!=""){var thumbUrl=$("> div",elem).eq(i).attr("data-thumb"),newImg=new Image;newImg.src=thumbUrl;$("li.pag_nav_"+i,pagination).append($(newImg).attr("class","camera_thumb").css({"position":"absolute"}).animate({opacity:0},0));$("li.pag_nav_"+i+" > img",pagination).after('<div class="thumb_arrow" />');$("li.pag_nav_"+i+" > .thumb_arrow",pagination).animate({opacity:0},0)}});wrap.css({marginBottom:$(pagination).outerHeight()})}}else if(!$(thumbs).length&&
$(pagination).length)wrap.css({marginBottom:$(pagination).outerHeight()});var firstPos=true;function thumbnailPos(){if($(thumbs).length&&!$(pagination).length){var wTh=$(thumbs).outerWidth(),owTh=$("ul > li",thumbs).outerWidth(),pos=$("li.cameracurrent",thumbs).length?$("li.cameracurrent",thumbs).position():"",ulW=$("ul > li",thumbs).length*$("ul > li",thumbs).outerWidth(),offUl=$("ul",thumbs).offset().left,offDiv=$("> div",thumbs).offset().left,ulLeft;if(offUl<0)ulLeft="-"+(offDiv-offUl);else ulLeft=
offDiv-offUl;if(firstPos==true){$("ul",thumbs).width($("ul > li",thumbs).length*$("ul > li",thumbs).outerWidth());if($(thumbs).length&&!$(pagination).lenght)wrap.css({marginBottom:$(thumbs).outerHeight()});thumbnailVisible();$("ul",thumbs).width($("ul > li",thumbs).length*$("ul > li",thumbs).outerWidth());if($(thumbs).length&&!$(pagination).lenght)wrap.css({marginBottom:$(thumbs).outerHeight()})}firstPos=false;var left=$("li.cameracurrent",thumbs).length?pos.left:"",right=$("li.cameracurrent",thumbs).length?
pos.left+$("li.cameracurrent",thumbs).outerWidth():"";if(left<$("li.cameracurrent",thumbs).outerWidth())left=0;if(right-ulLeft>wTh)if(left+wTh<ulW)$("ul",thumbs).animate({"margin-left":"-"+left+"px"},500,thumbnailVisible);else $("ul",thumbs).animate({"margin-left":"-"+($("ul",thumbs).outerWidth()-wTh)+"px"},500,thumbnailVisible);else if(left-ulLeft<0)$("ul",thumbs).animate({"margin-left":"-"+left+"px"},500,thumbnailVisible);else{$("ul",thumbs).css({"margin-left":"auto","margin-right":"auto"});setTimeout(thumbnailVisible,
100)}}}if($(commands).length){$(commands).append('<div class="camera_play"></div>').append('<div class="camera_stop"></div>');if(autoAdv==true){$(".camera_play",camera_thumbs_wrap).hide();$(".camera_stop",camera_thumbs_wrap).show()}else{$(".camera_stop",camera_thumbs_wrap).hide();$(".camera_play",camera_thumbs_wrap).show()}}function canvasLoader(){rad=0;var barWidth=$(".camera_bar_cont",camera_thumbs_wrap).width(),barHeight=$(".camera_bar_cont",camera_thumbs_wrap).height();if(loader!="pie")switch(barDirection){case "leftToRight":$("#"+
pieID).css({"right":barWidth});break;case "rightToLeft":$("#"+pieID).css({"left":barWidth});break;case "topToBottom":$("#"+pieID).css({"bottom":barHeight});break;case "bottomToTop":$("#"+pieID).css({"top":barHeight});break}else ctx.clearRect(0,0,opts.pieDiameter,opts.pieDiameter)}canvasLoader();$(".moveFromLeft, .moveFromRight, .moveFromTop, .moveFromBottom, .fadeIn, .fadeFromLeft, .fadeFromRight, .fadeFromTop, .fadeFromBottom",fakeHover).each(function(){$(this).css("visibility","hidden")});opts.onStartLoading.call(this);
nextSlide();function nextSlide(navSlide){elem.addClass("camerasliding");videoPresent=false;var vis=parseFloat($("div.cameraSlide.cameracurrent",target).index());if(navSlide>0)var slideI=navSlide-1;else if(vis==amountSlide-1)var slideI=0;else var slideI=vis+1;var slide=$(".cameraSlide:eq("+slideI+")",target);var slideNext=$(".cameraSlide:eq("+(slideI+1)+")",target).addClass("cameranext");if(vis!=slideI+1)slideNext.hide();$(".cameraContent",fakeHover).fadeOut(600);$(".camera_caption",fakeHover).show();
$(".camerarelative",slide).append($("> div ",elem).eq(slideI).find("> div.camera_effected"));$(".camera_target_content .cameraContent:eq("+slideI+")",wrap).append($("> div ",elem).eq(slideI).find("> div"));if(!$(".imgLoaded",slide).length){var imgUrl=allImg[slideI];var imgLoaded=new Image;imgLoaded.src=imgUrl+"?"+(new Date).getTime();slide.css("visibility","hidden");slide.prepend($(imgLoaded).attr("class","imgLoaded").css("visibility","hidden"));var wT,hT;if(!$(imgLoaded).get(0).complete||wT=="0"||
hT=="0"||typeof wT==="undefined"||wT===false||typeof hT==="undefined"||hT===false){$(".camera_loader",wrap).delay(500).fadeIn(400);imgLoaded.onload=function(){wT=imgLoaded.naturalWidth;hT=imgLoaded.naturalHeight;$(imgLoaded).attr("data-alignment",allAlign[slideI]).attr("data-portrait",allPor[slideI]);$(imgLoaded).attr("width",wT);$(imgLoaded).attr("height",hT);target.find(".cameraSlide_"+slideI).hide().css("visibility","visible");resizeImage();nextSlide(slideI+1)}}}else{if(allImg.length>slideI+1&&
!$(".imgLoaded",slideNext).length){var imgUrl2=allImg[slideI+1];var imgLoaded2=new Image;imgLoaded2.src=imgUrl2+"?"+(new Date).getTime();slideNext.prepend($(imgLoaded2).attr("class","imgLoaded").css("visibility","hidden"));imgLoaded2.onload=function(){wT=imgLoaded2.naturalWidth;hT=imgLoaded2.naturalHeight;$(imgLoaded2).attr("data-alignment",allAlign[slideI+1]).attr("data-portrait",allPor[slideI+1]);$(imgLoaded2).attr("width",wT);$(imgLoaded2).attr("height",hT);resizeImage()}}opts.onLoaded.call(this);
