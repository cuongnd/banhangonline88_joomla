//huong dan su dung // jQuery Plugin for SprFlat admin default_position // Control options and basic function of default_position // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function($){// here we go! $.default_position=function(element,options){// plugin's default options
        var defaults = {
    ...
    $.fn.default_position = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('default_position')) {
                ...
                $(this).data('default_position',plugin)}})}})(jQuery);