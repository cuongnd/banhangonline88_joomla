//huong dan su dung // jQuery Plugin for SprFlat admin mod_wishlist // Control options and basic function of mod_wishlist // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function ($){// here we go! $.mod_wishlist=function (element,options){// plugin's default options
        var defaults = {
    ...
    $.fn.mod_wishlist = function (options) {
        ...
        return this.each(function () {
            ...
            if (undefined == $(this).data('mod_wishlist')) {
                ...
                $(this).data('mod_wishlist',plugin)}})}})(jQuery);