//huong dan su dung // jQuery Plugin for SprFlat admin mod_menu_default // Control options and basic function of mod_menu_default // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function($){// here we go! $.mod_menu_default=function(element,options){// plugin's default options
        var defaults = {
        ...
        plugin.load_module = function() {
            ...
            var data_submit={};
            data_submit.module_id=plugin.settings.module_id;
            var ajax_web_design=$.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.success==true)
                    {
                        ...
                        $element.find('.wrapper-content').fadeOut( 300, function() {
                            $( this ).remove();
                        });
                        $element.html(data);
        ...
        plugin.init = function() {
            ...
            if(lazyload) {
                ...
                $(document.body).on('appear', $element, function (e, $affected) {
    ...
    $.fn.mod_menu_default = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('mod_menu_default')) {
                ...
                $(this).data('mod_menu_default',plugin)}})}})(jQuery);