//huong dan su dung // jQuery Plugin for SprFlat admin menucategory // Control options and basic function of menucategory // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function($){// here we go! $.menucategory=function(element,options){// plugin's default options
        var defaults = {
    ...
    $.fn.menucategory = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('menucategory')) {
                ...
                $(this).data('menucategory',plugin)}})}})(jQuery);