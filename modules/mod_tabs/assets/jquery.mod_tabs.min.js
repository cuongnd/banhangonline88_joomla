//huong dan su dung // jQuery Plugin for SprFlat admin mod_tabs // Control options and basic function of mod_tabs // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function ($){// here we go! $.mod_tabs=function (element,options){// plugin's default options
        var defaults = {
        ...
        plugin.init = function () {
            ...
            $element.find('.tabs').zozoTabs({
                ...
                select: function (event, item) {
                    ...
                    var Itemid=plugin.settings.Itemid;
                    $(this).addClass('hover');
                    ...
                    var $content_inner=$(this).find('.ajax-loading.z-active');
    ...
    $.fn.mod_tabs = function (options) {
        ...
        return this.each(function () {
            ...
            if (undefined == $(this).data('mod_tabs')) {
                ...
                $(this).data('mod_tabs',plugin)}})}})(jQuery);