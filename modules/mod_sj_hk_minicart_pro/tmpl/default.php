...
$cls_empty = (!$cart->products) || empty($cart->products) ? ' mc-cart-empty' : '';
?>
...
<div class="sj-minicart-pro <?php echo $cls_empty ?>" id="<?php echo $tag_id; ?>">
	<div class="mc-wrap"><!-- Begin mc-wrap -->
		...
		<div class="mc-header">
			<div class="mc-yourcart">
				...
				<span class="mc-totalproduct"><?php if ($cart->products) echo count($cart->products);
					else echo('0'); ?></span>
				<span
					class="mc-status"> <?php echo (count($cart->products) > 1) ? JText::_('ITEMS') : JText::_('ITEM') ?> </span>
			</div>
	...
	<a class="mc-checkout-top"
	   href="<?php echo $cart->checkout; ?>"  <?php echo HKMinicartproHelper::parseTarget($params->get('item_link_target')); ?> >
