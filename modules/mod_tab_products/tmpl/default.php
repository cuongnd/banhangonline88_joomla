    ...
    <div class="tab-product">
        <ul>
            ...
            <?php foreach ($list_category_product as $category) { ?>
                ...
                ?>
                <li><a><?php echo $image->display($icon, false, "icon img-responsive", '', '', 25, 25); ?><?php echo $category->detail->category_name ?></a></li>
            <?php } ?>
        </ul>
                            ...
                            <div class="row-fluid">
                                <?php foreach ($list_product AS $product) { ?>
                                    ...
                                    <div class="span<?php echo 12 / $column ?>">
                                        <div class="item">
                                            <?php echo $image->display($fist_image, false, "", 'class="icon  img-responsive"', '', 200, 300); ?>
                                    ...
                                    <div class="list-sub-category vertical">
                                        <ul class="vertical">
                                            <?php for($i=$total_column_sub_category;$i<count($list_sub_category_detail);$i++){ ?>
                                                ...
                                                ?>
                                                <li><a class="sub-category" data-category_id="<?php echo $sub_category->category_id ?>" href="javascript:void(0)"><?php echo $image->display($first_icon, false, "", 'class="icon  img-responsive"', '', 200,300); ?><div class="category-name"><?php echo JString::sub_string($sub_category->category_name,20) ?></div></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
