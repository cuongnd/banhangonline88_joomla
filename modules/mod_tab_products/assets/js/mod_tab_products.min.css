//huong dan su dung // jQuery Plugin for SprFlat admin mod_tab_products // Control options and basic function of mod_tab_products // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function ($){// here we go! $.mod_tab_products=function (element,options){// plugin's default options
        var defaults = {
        ...
        plugin.set_event_tab_select=function(){
            ...
            $element.find('#tab_product_' + module_id).zozoTabs({
                ...
                select: function (event, item) {
                    ...
                    z_container_height=$(item.tab.context).find('.z-container').height();
                    $content_inner.height(z_container_height);
    ...
    $.fn.mod_tab_products = function (options) {
        ...
        return this.each(function () {
            ...
            if (undefined == $(this).data('mod_tab_products')) {
                ...
                $(this).data('mod_tab_products',plugin)}})}})(jQuery);