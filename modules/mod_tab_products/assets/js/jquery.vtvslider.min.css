//huong dan su dung // jQuery Plugin for SprFlat admin vtvslider // Control options and basic function of vtvslider // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function($){// here we go! $.vtvslider=function(element,options){// plugin's default options
        var defaults = {
        ...
        plugin.init = function() {
            ...
            $list_product.find('>.slide.item').remove();
            var first_list_item=plugin.settings.list_item[0];
            if(typeof first_list_item !="undefined")
            {
                for(var i=0;i<first_list_item.length;i++){
                    var item=first_list_item[i];
                    $(item).appendTo($list_product);
    ...
    $.fn.vtvslider = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('vtvslider')) {
                ...
                $(this).data('vtvslider',plugin)}})}})(jQuery);