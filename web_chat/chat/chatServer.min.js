...
ExistsNickName=function(name,token){var listSocket=io.sockets.sockets;var flag_exists=false;listSocket.forEach(function(itemSocket){if(itemSocket.token!=token&&itemSocket.name==name){flag_exists=true;console.log("itemSocket.token:"+itemSocket.token);console.log("token:"+token);console.log("itemSocket.name:"+itemSocket.name);console.log("name:"+name)}});return flag_exists};
