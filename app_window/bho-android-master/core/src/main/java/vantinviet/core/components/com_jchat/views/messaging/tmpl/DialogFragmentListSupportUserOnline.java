...
public class DialogFragmentListSupportUserOnline extends DialogFragment {
...
/*
                        ExpandableRelativeLayout expandableRelativeLayoutGroup = (ExpandableRelativeLayout)recyclerViewGroupSupport.findViewWithTag("recyclerViewListSupportUserOnline");

                        expandableRelativeLayoutGroup.setExpanded(true);
                        for (GroupSupportUser groupSupportUser: listGroupSupport) {
                            ...
                            for (Map.Entry<String, JUser> entry : mapListSupportUserOnline.entrySet())
                            {
                                ...
                                if(Arrays.asList(listUserIdSupport).contains(user.getId())){
