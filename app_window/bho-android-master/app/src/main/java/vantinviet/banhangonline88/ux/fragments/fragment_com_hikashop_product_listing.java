...
public class fragment_com_hikashop_product_listing extends Fragment {

    private static final String PRODUCT_ID = "product_id";
    private final DrawerMenuItem drawerMenuItem;
    private final DrawerMenuItem page;
    ...
    @SuppressLint("ValidFragment")
    public fragment_com_hikashop_product_listing(DrawerMenuItem drawerMenuItem, Page page) {
