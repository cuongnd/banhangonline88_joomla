...
public class MenuDrawerFragment extends Fragment {
    ...
    private void prepareDrawerRecycler(View view) {
        ...
        drawerRecyclerAdapter = new DrawerRecyclerAdapter(getContext(), new DrawerRecyclerInterface() {
            @Override
            public void onMenuItemSelected(View v, DrawerMenuItem drawerMenuItem) {
                if (drawerMenuItem.getChildren() == null || drawerMenuItem.getChildren().isEmpty()) {
                    if (drawerListener != null) {
                        drawerListener.onDrawerMenuItemSelected(drawerMenuItem);
                        closeDrawerMenu();
                    ...
                    animateSubListShow(drawerMenuItem);
            }
        ...
        drawerSubmenuRecyclerAdapter = new DrawerSubmenuRecyclerAdapter(new DrawerSubmenuRecyclerInterface() {
            @Override
            public void onSubCategorySelected(View v, DrawerMenuItem drawerMenuItem) {
                if (drawerListener != null) {
                    drawerListener.onDrawerMenuItemSelected(drawerMenuItem);
                    closeDrawerMenu();
                }
...
//                toolbar.setAlpha(1 - slideOffset / 2);
    ...
    private void animateSubListShow(DrawerMenuItem drawerMenuItem) {
        if (drawerMenuItem != null) {
            drawerSubmenuTitle.setText(drawerMenuItem.getName());
            drawerSubmenuRecyclerAdapter.changeDrawerItems(drawerMenuItem.getChildren());
    ...
    /**
     * Interface defining events initiated by {@link MenuDrawerFragment}.
     */
    public interface FragmentDrawerListener {
        ...
        /**
         * Launch {@link PageMenuItemFragment}.
         *
         * @param drawerMenuItem object specifying selected item in the drawer.
         */
