package vantinviet.banhangonline88.libraries.legacy.controller;
...
public class JControllerLegacy {
    ...
    public static JControllerLegacy getInstance(String option) {
        ...
        try {
            control_class = Class.forName(String.format("vantinviet.banhangonline88.components.com_%s.%sController",option,controller));
    ...
    public void display() {
        ...
        Class<?> control_class = null;
        try {
            control_class = Class.forName(String.format("vantinviet.banhangonline88.components.%s.views.%s.tmpl.%s",option,view,layout));
