...
"easyblog/media/editor.video.player":'\r\n<div id="[%= id %]" class="playerContainer"></div>\r\n',"easyblog/dashboard/dashboard.tags.item":'<li class="tag-item">\r\n\t<a href="javascript: void(0);" class="remove-tag">x</a>\r\n\t<span class="tag-title">[%= title %]</span>\r\n</li>\r\n'});$.require.language.loader({"COM_EASYBLOG_MM_UNABLE_TO_FIND_EXPORTER":"Unable to find exporter for this item type.","COM_EASYBLOG_MM_GETTING_IMAGE_SIZES":"Getting image sizes.","COM_EASYBLOG_MM_UNABLE_TO_RETRIEVE_VARIATIONS":"Unable to retrieve image variations.",
"COM_EASYBLOG_MM_ITEM_INSERTED":"Item inserted.","COM_EASYBLOG_MM_UPLOADING":"Uploading","COM_EASYBLOG_MM_UPLOADING_STATE":"Uploading...","COM_EASYBLOG_MM_UPLOADING_PENDING":"Pending","COM_EASYBLOG_MM_UPLOAD_COMPLETE":"Complete.","COM_EASYBLOG_MM_UPLOAD_PREPARING":"Preparing to upload.","COM_EASYBLOG_MM_UPLOAD_UNABLE_PARSE_RESPONSE":"Unable to parse server response.","COM_EASYBLOG_MM_UPLOADING_LEFT":"left","COM_EASYBLOG_MM_CONFIRM_DELETE_ITEM":"Are you sure you want to delete this item?","COM_EASYBLOG_MM_CANCEL_BUTTON":"Cancel",
"COM_EASYBLOG_MM_YES_BUTTON":"Yes","COM_EASYBLOG_MM_ITEM_DELETE_CONFIRMATION":"Are you sure you want to delete the item "})});
