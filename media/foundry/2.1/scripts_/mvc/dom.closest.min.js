(function(){var moduleFactory=function($){var module=this;var exports=function(){var oldClosest=$.fn.closest;$.fn.closest=function(selectors,context){var rooted={},res,result,thing,i,j,selector,rootedIsEmpty=true,selector,selectorsArr=selectors;if(typeof selectors=="string")selectorsArr=[selectors];$.each(selectorsArr,function(i,selector){if(selector.indexOf(">")==0){if(selector.indexOf(" ")!=-1)throw" closest does not work with > followed by spaces!";rooted[selectorsArr[i]=selector.substr(1)]=selector;
