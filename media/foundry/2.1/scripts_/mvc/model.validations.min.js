(function(){var moduleFactory=function($){var module=this;$.require().script("mvc/model").done(function(){var exports=function(){var validate=function(attrNames,options,proc){if(!proc){proc=options;options={}}options=options||{};attrNames=$.makeArray(attrNames);if(options.testIf&&!options.testIf.call(this))return;var self=this;$.each(attrNames,function(i,attrName){if(!self.validations[attrName])self.validations[attrName]=[];self.validations[attrName].push(function(){var res=proc.call(this,this[attrName]);
