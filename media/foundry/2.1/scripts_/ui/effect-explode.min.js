...
0:1}).animate({left:left+(show?0:mx*width),top:top+(show?0:my*height),opacity:show?1:0},o.duration||500,o.easing,childComplete)}}function animComplete(){el.css({visibility:"visible"});$(pieces).remove();if(!show)el.hide();done()}}})(jQuery)};exports();module.resolveWith(exports)})};dispatch("ui/effect-explode").containing(moduleFactory).to("Foundry/2.1 Modules")})();
