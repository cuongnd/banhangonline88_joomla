(function(){var moduleFactory=function($){var module=this;var jQuery=$;var exports=function(){(function(window,$,undefined){$.infinitescroll=function infscr(options,callback,element){this.element=$(element);this._create(options,callback)};$.infinitescroll.defaults={loading:{finished:undefined,finishedMsg:"<em>Congratulations, you've reached the end of the internet.</em>",img:"http://www.infinite-scroll.com/loading.gif",msg:null,msgText:"<em>Loading the next set of posts...</em>",selector:null,speed:"fast",
start:undefined},state:{isDuringAjax:false,isInvalidPage:false,isDestroyed:false,isDone:false,isPaused:false,currPage:1},callback:undefined,debug:false,behavior:undefined,binder:$(window),nextSelector:"div.navigation a:first",navSelector:"div.navigation",contentSelector:null,extraScrollPx:150,itemSelector:"div.post",animate:false,pathParse:undefined,dataType:"html",appendCallback:true,bufferPx:40,errorCallback:function(){},infid:0,pixelsFromNavToBottom:undefined,path:undefined};$.infinitescroll.prototype=
{_binding:function infscr_binding(binding){var instance=this,opts=instance.options;opts.v="2.0b2.111027";if(!!opts.behavior&&this["_binding_"+opts.behavior]!==undefined){this["_binding_"+opts.behavior].call(this);return}if(binding!=="bind"&&binding!=="unbind"){this._debug("Binding value  "+binding+" not valid");return false}if(binding=="unbind")this.options.binder.unbind("smartscroll.infscr."+instance.options.infid);else this.options.binder[binding]("smartscroll.infscr."+instance.options.infid,function(){instance.scroll()});
this._debug("Binding",binding)},_create:function infscr_create(options,callback){if(!this._validate(options))return false;var opts=this.options=$.extend(true,{},$.infinitescroll.defaults,options),path=$(opts.nextSelector).attr("href");opts.contentSelector=opts.contentSelector||this.element;opts.loading.selector=opts.loading.selector||opts.contentSelector;if(!path){this._debug("Navigation selector not found");return}opts.path=this._determinepath(path);opts.loading.msg=$('<div id="infscr-loading"><img alt="Loading..." src="'+
opts.loading.img+'" /><div>'+opts.loading.msgText+"</div></div>");(new Image).src=opts.loading.img;opts.pixelsFromNavToBottom=$(document).height()-$(opts.navSelector).offset().top;opts.loading.start=opts.loading.start||function(){$(opts.navSelector).hide();opts.loading.msg.appendTo(opts.loading.selector).show(opts.loading.speed,function(){beginAjax(opts)})};opts.loading.finished=opts.loading.finished||function(){opts.loading.msg.fadeOut("normal")};opts.callback=function(instance,data){if(!!opts.behavior&&
instance["_callback_"+opts.behavior]!==undefined)instance["_callback_"+opts.behavior].call($(opts.contentSelector)[0],data);if(callback)callback.call($(opts.contentSelector)[0],data,opts)};this._setup()},_debug:function infscr_debug(){if(this.options&&this.options.debug)return window.console&&console.log.call(console,arguments)},_determinepath:function infscr_determinepath(path){var opts=this.options;if(!!opts.behavior&&this["_determinepath_"+opts.behavior]!==undefined){this["_determinepath_"+opts.behavior].call(this,
...
false;callback(this,data)},_nearbottom:function infscr_nearbottom(){var opts=this.options,pixelsFromWindowBottomToBottom=0+$(document).height()-opts.binder.scrollTop()-$(window).height();if(!!opts.behavior&&this["_nearbottom_"+opts.behavior]!==undefined)return this["_nearbottom_"+opts.behavior].call(this);this._debug("math:",pixelsFromWindowBottomToBottom,opts.pixelsFromNavToBottom);return pixelsFromWindowBottomToBottom-opts.bufferPx<opts.pixelsFromNavToBottom},_pausing:function infscr_pausing(pause){var opts=
...
args)},execAsap==="execAsap"?0:100)}};$.fn.smartscroll=function(fn){return fn?this.bind("smartscroll",fn):this.trigger("smartscroll",["execAsap"])}})(window,jQuery)};exports();module.resolveWith(exports)};dispatch("infinitescroll").containing(moduleFactory).to("Foundry/2.1 Modules")})();
