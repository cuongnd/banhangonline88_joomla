...
return sa?s:s[0]},_verifyWrapper:function(){$("body > [id=fd].gritter").length<1&&$(document.createElement("div")).attr("id","fd").addClass("gritter").css({position:"absolute",top:0,left:0,overflow:"visible",width:0,height:0,zIndex:10003}).appendTo("body"),0==$("#gritter-notice-wrapper").length&&$("[id=fd].gritter").append(this._tpl_wrap)}}}(jQuery)};exports(),module.resolveWith(exports)};FD40.module("gritter",moduleFactory)}();