...
},reset:function(){var overlay=self.overlay(),overlayDefault=overlay.data("default");void 0!==overlayDefault?overlay.html($("<div>").html(overlayDefault).html()):overlay.empty();var textarea=self.textarea(),textareaDefault=textarea.data("default");void 0!==textareaDefault?textarea.val($("<div>").html(textareaDefault).text()):textarea.val(""),self.caretBefore=self.caretAfter={start:0,end:0},self.previousMarker=null,self.normalize(),self.initialFocus=!0,self.trigger("triggerClear")},getTrigger:function(key){var triggers=self.options.triggers;
...
},lengthBefore:0,caretBefore:{start:0,end:0},caretAfter:{start:0,end:0},skipKeydown:!1,previousMarker:null,initialFocus:!0,"{textarea} focus":function(){self.initialFocus&&self.textarea().caret(self.initialCaret||0)},"{textarea} keydown":function(textarea,event){self.initialFocus=!1,self.skipKeydown||(self.caretBefore=textarea.caret(),8===event.keyCode&&$.IE<10&&self.overlay().css("opacity",0),self.skipKeydown=!0)},"{textarea} keypress":function(textarea,event){self.caretBefore=textarea.caret(),8===event.keyCode
