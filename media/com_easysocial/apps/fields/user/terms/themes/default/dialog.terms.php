...
<dialog>
	...
	<content>
		<textarea class="form-control input-sm es-terms-field" readonly="readonly" data-field-terms-textbox><?php echo $params->get('message', JText::_('PLG_FIELDS_TERMS_CONDITION_MESSAGE_TERMS'));?></textarea>
	</content>
	<buttons>
