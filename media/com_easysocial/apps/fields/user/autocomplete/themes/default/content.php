...
<div data-autocomplete-wrapper-<?php echo $field->id;?>>
    <div class="textboxlist disabled" data-field-suggest>            
        ...
        <input type="text" autocomplete="off" disabled class="textboxlist-textField o-form-control" data-textboxlist-textField placeholder="<?php echo JText::_($params->get('placeholder', ''));?>" />
    </div>
</div>