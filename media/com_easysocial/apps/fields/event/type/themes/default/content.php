...
<div class="controls-description mb-15">
    <label class="radio" for="event_type_public">
        ...
        <i class="ies-earth"></i> <?php echo JText::_('FIELDS_EVENT_TYPE_PUBLIC'); ?>
    </label>
...
<div class="controls-description mb-15">
    <label class="radio" for="event_type_private">
        ...
        <i class="ies-user-2"></i> <?php echo JText::_('FIELDS_EVENT_TYPE_PRIVATE'); ?>
    </label>
...
<div class="controls-description mb-15">
    <label class="radio" for="event_type_invite">
        ...
        <i class="ies-locked"></i> <?php echo JText::_('FIELDS_EVENT_TYPE_INVITE_ONLY'); ?>
    </label>
