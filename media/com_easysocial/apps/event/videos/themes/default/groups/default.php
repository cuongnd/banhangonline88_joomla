    ...
    <div class="es-content">
        ...
        <div class="es-filterbar">
            <div class="filterbar-title h5">
                ...
                <a href="<?php echo FRoute::videos(array('layout' => 'form', 'uid' => $group->id, 'type' => SOCIAL_TYPE_GROUP));?>" class="pull-right btn btn-es-default btn-sm"><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_ADD_VIDEO');?></a>
            </div>
        </div>
