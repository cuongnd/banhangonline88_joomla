            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <div class="discussion-meta fd-small">
                        <?php if ($files) { ?>
                            <i class="ies-attachment" data-original-title="<?php echo JText::_('APP_EVENT_DISCUSSIONS_CONTAIN_ATTACHMENTS', true); ?>" data-es-provide="tooltip"></i>&nbsp;
                        <?php } ?>
                        <i class="ies-calendar"></i>&nbsp; <?php echo JText::sprintf('APP_EVENT_DISCUSSIONS_CONTENT_POSTED_ON_META', FD::date($discussion->created)->format(JText::_('DATE_FORMAT_LC1'))); ?>
                    </div>
                </div>
            </div>
