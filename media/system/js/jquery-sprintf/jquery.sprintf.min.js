/*-----start----/media/system/js/jquery-sprintf/jquery.sprintf.js---------*/jQuery.vsprintf=function jQuery_vsprintf(format,args){if(format==null){throw "Not enough arguments for vsprintf"}
if(args==null){args=[]}
...
var ret=jQuery.vsprintf(format,args);if(window.console){window.console.info(ret)}else{window.dump(ret)}};/*-----end----/media/system/js/jquery-sprintf/jquery.sprintf.js---------*/