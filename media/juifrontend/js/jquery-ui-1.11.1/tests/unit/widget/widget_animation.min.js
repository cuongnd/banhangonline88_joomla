module("widget animation",function(){var show=$.fn.show,fadeIn=$.fn.fadeIn,slideDown=$.fn.slideDown;return{setup:function(){$.widget("ui.testWidget",{_create:function(){this.element.hide()},show:function(fn){this._show(this.element,this.options.show,fn)}});$.effects={effect:{testEffect:$.noop}}},teardown:function(){delete $.ui.testWidget;delete $.effects.effect.testEffect;$.fn.show=show;$.fn.fadeIn=fadeIn;$.fn.slideDown=slideDown}}}());
