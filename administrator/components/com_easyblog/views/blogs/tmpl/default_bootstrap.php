			...
			<?php if( $this->blogs ){ ?>
				...
				<tr>
					...
					<td class="nowrap hidden-phone center">
						<?php
							$extGroupName = '';
							if( !empty($row->external_group_id) && EasyBlogHelper::getHelper('Groups')->useGroups())
							{
					...
					<td class="center">
						<?php echo EasyBlogDateHelper::toFormat( EasyBlogDateHelper::getDate( $row->created ) , 'Y-m-d H:i:s'); ?>
					</td>
