...
class MaximenuckViewItems extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// JFactory::getApplication()->redirect('index.php?option=com_maximenuck&view=items&format=raw&menutype='.JFactory::getApplication()->input->get('menutype'));
		$lang 		= JFactory::getLanguage();
		$this->items	= $this->get('Items');
		require_once(JPATH_ADMINISTRATOR . '/components/com_maximenuck/models/moduleselect.php');
//		$modules = new MaximenuckModelModuleselect();
