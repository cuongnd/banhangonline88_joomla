...
<script src="<?php echo JUri::root(true) ?>/administrator/components/com_maximenuck/assets/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo JUri::root(true) ?>/administrator/components/com_maximenuck/assets/jquery-noconflict.js" type="text/javascript"></script>
