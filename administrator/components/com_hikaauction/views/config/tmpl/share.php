...
?><form action="index.php?tmpl=component&amp;option=<?php echo HIKAAUCTION_COMPONENT ?>" method="post"  name="adminForm" id="adminForm" >
	<fieldset>
	...
	<fieldset class="adminform">
		<?php hikaauction::display(JText::_('SHARE_CONFIRMATION_1').'<br/>'.JText::_('SHARE_CONFIRMATION_2').'<br/>'.JText::_('SHARE_CONFIRMATION_3'),'info'); ?><br/>
		<textarea cols="100" rows="8" name="mailbody">Hi Hikari Software team,
Here is a new version of the language file for HikaAuction, I translated few more strings...</textarea>
	</fieldset>
	<div class="clr"></div>
