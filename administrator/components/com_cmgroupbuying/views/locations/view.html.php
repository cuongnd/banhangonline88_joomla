...
class CMGroupBuyingViewLocations extends JViewLegacy
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_CMGROUPBUYING_LOCATION_MANAGER'), 'location.png');
		...
		JToolBarHelper::divider();
		JToolBarHelper::deleteList(JText::_('COM_CMGROUPBUYING_WARNING_DELETE_ITEMS'), 'locations.delete');
	}
}