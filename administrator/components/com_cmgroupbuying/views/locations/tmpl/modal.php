...
$function = JFactory::getApplication()->input->get('function', 'jSelectLocation', 'word');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_cmgroupbuying&view=locations&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
	<fieldset class="filter clearfix">
		<div class="left">
			...
			<?php if (JFactory::getApplication()->isAdmin()) : ?>
				<button onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('', '<?php echo $this->escape(addslashes(JText::_('COM_CMGROUPBUYING_SELECT_LOCATION'))); ?>', null, null);" class="btn" type="button"><?php echo JText::_('COM_CMGROUPBUYING_NONE'); ?></button>
			<?php endif; ?>
		</div>
