			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th>
							<?php echo JHtml::_('grid.sort', 'COM_CMGROUPBUYING_PRODUCT_FIELD_NAME_LABEL', 'a.name', $listDirn, $listOrder); ?>
						</th>
						<th>
				...
				?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							<a href="<?php echo JRoute::_('index.php?option=com_cmgroupbuying&task=product.edit&id='.(int) $item->id); ?>">
						...
						<td class="order center">
							<?php if ($saveOrder) :?>
								<?php if ($listDirn == 'asc') : ?>
									...
									<span><?php echo $this->pagination->orderDownIcon($i, $n, true, 'products.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
								<?php elseif ($listDirn == 'desc') : ?>
									<span><?php echo $this->pagination->orderUpIcon($i, true,'products.orderdown', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
									<span><?php echo $this->pagination->orderDownIcon($i, $n, true, 'products.orderup', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
								<?php endif; ?>
							<?php endif; ?>
