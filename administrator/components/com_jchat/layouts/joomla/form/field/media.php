...
<div class="field-media-wrapper"
	...
	?>
	<?php if ($showPreview) : ?>
	<div class="input-prepend input-append mediaimagefield">
	...
	<?php endif; ?>
			<input type="text" name="<?php echo $name; ?>" data-mediaidentifier="<?php echo $field->dataIdentifier; ?>" id="<?php echo $id; ?>" value="<?php echo htmlspecialchars($value, ENT_COMPAT, 'UTF-8'); ?>" readonly="readonly"<?php echo $attr; ?>/>
