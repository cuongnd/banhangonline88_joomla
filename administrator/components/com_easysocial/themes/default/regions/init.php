...
<div class="row" data-base>
    <div class="col-md-12">
        <div class="widget-box">
            <h3><?php echo JText::_('COM_EASYSOCIAL_REGIONS_INITIALISE_REGIONS'); ?></h3>
            ...
            <table class="table table-striped table-noborder" style="display: none;" data-table>
                ...
                <tbody data-table-body>
                    <tr data-table-row data-key="clear" style="display: none;">
                        ...
                        <td class="center">
                            <span class="label label-warning" data-row-status><i data-row-icon class="ies-wrench-3"></i></span>
                        </td>
                    </tr>
