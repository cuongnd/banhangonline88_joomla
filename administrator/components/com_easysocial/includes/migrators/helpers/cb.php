...
class SocialMigratorHelperCB extends SocialMigratorHelper
{
	...
	private function processField( $stepId, $cbField, $esProfileId )
	{
		...
		$fieldTable->display_title          = $cbField->displaytitle;
		$fieldTable->display_description    = $cbField->displaytitle; // if title display, then we display the description as well
