...
<div class="row-fluid">
	<div class="span12 panel-title">
		<h2><?php echo JText::_( 'COM_EASYDISCUSS_SETTINGS_AUP_INTEGRATIONS_TITLE' );?></h2>
		<p style="margin: 0 0 15px;">
			<?php echo JText::_( 'COM_EASYDISCUSS_SETTINGS_AUP_INTEGRATIONS_DESC' );?>
		</p>
	...
	<div class="span6">
		<div class="widget accordion-group">
			<div class="whead accordion-heading">
				...
				<h6><?php echo JText::_( 'COM_EASYDISCUSS_AUP_INTEGRATIONS' ); ?></h6>
				...
				<div class="wbody">
					<div class="si-form-row">
						...
						<div class="span7"
							rel="ed-popover"
							data-placement="left"
							data-original-title="<?php echo JText::_( 'COM_EASYDISCUSS_SETTINGS_AUP_ENABLE' ); ?>"
							data-content="<?php echo JText::_('COM_EASYDISCUSS_SETTINGS_AUP_ENABLE_DESC'); ?>"
						>
