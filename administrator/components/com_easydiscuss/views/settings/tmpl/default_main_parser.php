...
function testParser()
{
	var server		= discussQuery('input[name=main_email_parser_server]').val();
	var port		= discussQuery('input[name=main_email_parser_port]').val();
	var service		= discussQuery('#main_email_parser_service').val();
	var ssl			= discussQuery('input[name=main_email_parser_ssl]').val();
	var user		= discussQuery('input[name=main_email_parser_username]').val();
	var pass		= discussQuery('input[name=main_email_parser_password]').val();
	var validate	= discussQuery('input[name=main_email_parser_validate]').val();
