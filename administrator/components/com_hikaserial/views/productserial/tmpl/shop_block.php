...
?><div class="hkc-xl-4 hkc-lg-6 hikashop_product_block hikashop_product_edit_serials"><div>
	<div class="hikashop_product_part_title hikashop_product_edit_serials_title"><?php echo JText::_('HIKA_SERIALS');?></div>
...
?>
			<tr class="row<?php echo $k; ?>" id="serial_pack_<?php echo $data->pack_id; ?>_<?php echo (int)$this->product_id; ?>">
				...
				<td align="center"><a href="#" onclick="window.hikaserial.deleteRow(this); return false;"><img src="<?php echo HIKASHOP_IMAGES;?>delete.png" alt="<?php echo JText::_('DELETE'); ?>"/></a></td>
			</tr>
<?php
	$k = 1 - $k;
}
?>
	...
	<div style="display:none;" class="hikaserial_dynamic_selector" id="hikaserial_selector_pack_line_<?php echo (int)$this->product_id; ?>">
		<?php
		...
		<div style="float:right">
			<button onclick="return window.productMgr.serial_addPack(this, <?php echo (int)$this->product_id; ?>);" class="btn btn-success"><img src="<?php echo HIKASHOP_IMAGES; ?>plus.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('ADD_PACKS'); ;?></button>
		</div>
		<button onclick="return window.productMgr.serial_togglePacks(this, <?php echo (int)$this->product_id; ?>);" class="btn btn-danger"><img src="<?php echo HIKASHOP_IMAGES; ?>cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
