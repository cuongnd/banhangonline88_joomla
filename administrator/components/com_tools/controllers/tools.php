 ...
 * @since  1.6
 */
class ToolsControllerTools extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_tools&view=tools');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'tool', $prefix = 'ToolsModel', $config = array())
	{
