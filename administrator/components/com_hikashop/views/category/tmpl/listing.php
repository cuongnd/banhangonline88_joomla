            ...
            <td style="vertical-align:top;">
                ...
                <div id="page-category" class="row-fluid">
                    ...
                    <div class="span9">
                        ...
                        <?php } ?>
                        <?php $count = 7; ?>
                        <form action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=category" method="post"
                                    ...
                                    <td>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                ...
                                                ?>
                                                <?php if (!$this->config->get('category_explorer')) { ?>
                                                    <a href="<?php echo hikashop_completeLink('category&task=listing&filter_id=0'); ?>"><?php echo JText::_('ROOT'); ?>
                                                        /</a>
                                                ...
                                                <input type="text" name="search" id="search"
                                                       ...
                                                       class="text_area"/>
                                                <button class="btn"
                                                        onclick="this.form.submit();"><?php echo JText::_('GO'); ?></button>
                                                <button class="btn"
...
<table id="hikashop_category_listing" class="adminlist table table-striped table-hover" cellpadding="1">
    ...
    <tr>
        ...
        <th class="title titleorder">
            <?php if (!$this->pageInfo->selectedType) {
                ...
                <a href="#"
                   title="<?php echo JText::_('CHANGE_SUB_ELEMENT_FILTER_TO_REORDER_ELEMENTS'); ?>"><?php echo JText::_('HIKA_ORDER'); ?></a>
            <?php } ?>
        </th>
    ...
    for ($i = 0, $a = count($this->rows); $i < $a; $i++) {
        ...
        <tr class="<?php echo "row$k"; ?>">
            ...
            <?php } ?>
            <td>
                <div style="background:#666b7e "><?php echo $this->image->display(@$row->icon_file_path, true, "", '', '', 100, 100); ?></div>
            </td>
            <td>
                ...
                <?php if (!$this->pageInfo->selectedType) {
                    if ($this->manage) { ?>
                        ...
                        <input type="text" name="order[]"
                               ...
                               value="<?php echo $row->category_ordering; ?>" class="text_area"
                               style="text-align: center"/>
                        <?php
                    } else {
                        echo $row->category_ordering;
                    }
                } else { ?>
                    <a href="#" title="<?php echo JText::_('CHANGE_SUB_ELEMENT_FILTER_TO_REORDER_ELEMENTS'); ?>"><img
                            src="<?php echo HIKASHOP_IMAGES; ?>delete2.png"
            ...
            <td align="center">
                <?php if ($this->manage) { ?>
                    <span id="<?php echo $publishedid ?>"
                          class="spanloading"><?php echo $this->toggleClass->toggle($publishedid, (int)$row->category_published, 'category') ?></span>
                <?php } else {
                    echo $this->toggleClass->display('activate', $row->category_published);
                } ?>
            </td>
            <td width="1%" align="center">
