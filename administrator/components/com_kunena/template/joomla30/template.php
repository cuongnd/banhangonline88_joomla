...
class KunenaAdminTemplate30
{
	...
	public function initialize()
	{
		...
		$document->addStyleSheet(JUri::base(true) . '/components/com_kunena/media/css/joomla301/layout.css');
		$document->addStyleSheet(JUri::base(true) . '/components/com_kunena/media/css/joomla301/styles.css');
	}
	...
	public function getTemplatePaths($path = '', $fullpath = false)
	{
		...
		$array   = array();
		$array[] = ($fullpath ? KPATH_ADMIN : KPATH_COMPONENT_RELATIVE) . '/template/joomla301' . $path;
