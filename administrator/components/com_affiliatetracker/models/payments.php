...
class PaymentsModelPayments extends JModelLegacy
{
	...
	function __construct(){
		...
		$cal_start = $mainframe->getUserStateFromRequest('affiliates.payments.cal_start','cal_start','','cal_start');
		$cal_end = $mainframe->getUserStateFromRequest('affiliates.payments.cal_end','cal_end','','cal_end');
		$status_id = $mainframe->getUserStateFromRequest('affiliates.payments.status_id','status_id','','status_id');
