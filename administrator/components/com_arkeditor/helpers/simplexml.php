...
class ARKSimpleXML extends JObject //Had to rename class to avoid conflict with extensions that do no check that the JSimpleXML has been already loaded
{
	/**
	 * The XML parser
	 *
 ...
 */
class ARKSimpleXMLElement extends JObject //renamed to ARKSimpleXMLElement to avoid extension that do no check if the JSimpleXMLElement is already loaded in!
{
	/**
