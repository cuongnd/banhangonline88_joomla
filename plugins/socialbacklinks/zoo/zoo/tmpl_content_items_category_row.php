<?php
/**    
 * SocialBacklinks Content Plugin Content Items Category Row custom template
 *
...
<tr class="<?php echo "row{$params->k}" . $class; ?>">
	<td align="center">
		...
		<input type="checkbox" id="<?php echo $params->item->id ?>" 
			<?php echo ( ($params->level > 1) || ($params->item->id == 0) ) ? 'name="categories" value="' . $params->item->id . '"' : 'disabled="disabled"'; ?>
