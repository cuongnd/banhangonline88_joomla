        ...
        public static function loadHelixOverwrite(){
             ...
             if (!JFactory::getApplication()->isAdmin()) {
                ...
                if( JVERSION >= 3 ){
                    ...
                    if (!class_exists('JViewLegacy', false))  self::getInstance()->Import('core/classes/joomla301/viewlegacy.php');
                    if (!class_exists('JModuleHelper', false)) self::getInstance()->Import('core/classes/joomla301/helper.php');
                    ...
                    if (!class_exists('JHtmlBootstrap', false)) Helix::Import('core/classes/joomla301/bootstrap.php');
                } 
            }
