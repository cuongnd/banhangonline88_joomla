 ...
 */
jQuery(function ($) {
    var check_is_main_frame=function($element){
        var is_main_frame=$element.data('is_main_frame');
        if(is_main_frame==1){
            alert('this element main frame, you can not edit it, if you want edit this please open this main frame');
            return true;
        }else{
            return false;
        }
    ...
    var columnInputs = function (element, name) {
        ...
        $(element).find('>.row_is_sub_content_input').attr('name', name + '[is_sub_content]');
    }
