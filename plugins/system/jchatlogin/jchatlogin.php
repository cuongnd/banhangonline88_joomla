		...
		if(!$app->getClientId() && $this->checkIfValidExecution($this->cParams, $app)) {
			...
			if($this->cParams->get('fblogin_active', 0)) {
				...
				switch ((int)$this->cParams->get ( 'sdkloadmode', '2' )) {
					// Override load mode
					case 2 :
						$doc->addScriptDeclaration ( "(function(d){var js, id = 'facebook-jssdk', ref = d.getElementsByTagName('script')[0];js = d.createElement('script');js.id = id;js.async = true;js.src = '//connect.facebook.net/en_US/all.js';ref.parentNode.insertBefore(js, ref);}(document));" );
						break;
					
					// No override load mode
					case 1 :
						$doc->addScriptDeclaration ( "(function(d) {var js, id = 'facebook-jssdk', ref = d.getElementsByTagName('script')[0];if (d.getElementById(id)){return;}js = d.createElement('script');js.id = id;js.async = true;js.src = '//connect.facebook.net/en_US/all.js';ref.parentNode.insertBefore(js, ref);}(document));" );
						break;
