<?php
// namespace administrator\components\com_jchat\framework\facebook;
/**
 ...
 * the file.
 */
abstract class JChatFacebookBase {
	/**
	 * Version.
	 */
	const VERSION = '3.1.1';
	...
	*/
	...
	protected function getUserFromAccessToken() {
		try {
			...
			return $user_info ['id'];
		} catch ( JChatFacebookException $e ) {
			return 0;
		}
	}
	...
	protected function makeRequest($url, $params, $ch = null) {
		...
		if ($result === false) {
			$e = new JChatFacebookException ( array (
	...
	protected function throwAPIException($result) {
		$e = new JChatFacebookException ( $result );
		switch ($e->getType ()) {
