<section id="skills" class="section-wrapper skills-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-4 wow slideInLeft">
                        <div class="progress-wrapper">
                            ...
                            <div class="progress-item">
                                <span class="progress-title">Web responsive</span>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                                         aria-valuemax="100" style="width: 90%"><span
                                            class="progress-percent"> 90%</span>
                            ...
                            <div class="progress-item">
                                <span class="progress-title">Nodejs</span>
                    ...
                    <div class="col-md-4 wow slideInRight">
                        <div class="progress-wrapper">
                            ...
                            <div class="progress-item">
                                <span class="progress-title">Github</span>
