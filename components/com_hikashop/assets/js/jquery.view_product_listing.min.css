//huong dan su dung // jQuery Plugin for SprFlat admin view_product_listing // Control options and basic function of view_product_listing // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function($){// here we go! $.view_product_listing=function(element,options){// plugin's default options
        var defaults = {
    ...
    $.fn.view_product_listing = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('view_product_listing')) {
                ...
                $(this).data('view_product_listing',plugin)}})}})(jQuery);