//huong dan su dung
/*
 $('.view_user_form').view_user_form();

 view_user_form=$('.view_user_form').data('view_user_form');
 console.log(view_user_form);
 */

// jQuery Plugin for SprFlat admin view_user_form
// Control options and basic function of view_user_form
...
(function ($) {
    ...
    // here we go!
    $.view_user_form = function (element, options) {
        ...
        var defaults = {
            ...
            //main color scheme for view_user_form
    ...
    $.fn.view_user_form = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('view_user_form')) {
                var plugin = new $.view_user_form(this, options);

                $(this).data('view_user_form', plugin);
