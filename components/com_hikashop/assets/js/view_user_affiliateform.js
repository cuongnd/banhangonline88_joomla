//huong dan su dung
/*
 $('.view_user_affiliateform').view_user_affiliateform();

 view_user_affiliateform=$('.view_user_affiliateform').data('view_user_affiliateform');
 console.log(view_user_affiliateform);
 */

// jQuery Plugin for SprFlat admin view_user_affiliateform
// Control options and basic function of view_user_affiliateform
...
(function ($) {
    ...
    // here we go!
    $.view_user_affiliateform = function (element, options) {
        ...
        var defaults = {
            ...
            //main color scheme for view_user_affiliateform
    ...
    $.fn.view_user_affiliateform = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('view_user_affiliateform')) {
                var plugin = new $.view_user_affiliateform(this, options);

                $(this).data('view_user_affiliateform', plugin);
