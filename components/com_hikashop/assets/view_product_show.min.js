//huong dan su dung // jQuery Plugin for SprFlat admin view_product_show // Control options and basic function of view_product_show // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function ($){// here we go! $.view_product_show=function (element,options){// plugin's default options
        var defaults = {
            product:{},
            list_language:{}
    ...
    $.fn.view_product_show = function (options) {
        ...
        return this.each(function () {
            ...
            if (undefined == $(this).data('view_product_show')) {
                ...
                $(this).data('view_product_show',plugin)}})}})(jQuery);