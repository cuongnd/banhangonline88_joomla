...
$response->url_checkout=$this->url_checkout;
        ...
        if ($this->params->get('small_cart')) {
            ...
            if ($this->cart_type == 'cart') {
                ...
                <a class="hikashop_small_cart_checkout_link"
                   href="<?php echo hikashop_completeLink('cart&task=showcart&cart_id=' . $this->element->cart_id . '&cart_type=' . $this->cart_type . $this->cart_itemid); ?>">
                    <span class="hikashop_small_cart_total_title"><?php echo $text; ?></span>
                </a>
                <?php
            }
            ...
            ?>
            <form
                action="<?php echo hikashop_completeLink('product&task=updatecart' . $this->url_itemid, false, true); ?>"
                            ...
                            <tr>
                                ...
                                switch ($row_count) {
                                    ...
                                    default:
                                        ...
                                        if ($colspan > 0) {
                                            ?>
                                            <td class="hikashop_cart_module_coupon_title"
                                ...
                                <tr>
                                    ...
                                    switch ($row_count) {
                                        ...
                                        default:
                                            ...
                                            if ($colspan > 0) {
                                                ?>
                                                <td class="hikashop_cart_module_shipping_title"
                                                    colspan="<?php echo $colspan; ?>"><?php
                        ...
                        <tr class="row<?php echo $k; ?>">
                            ...
                            if ($this->params->get('show_cart_product_name', 1)) {
                                ...
                                <td class="hikashop_cart_module_product_name_value hikashop_cart_value">
                                    <?php if (@$defaultParams['link_to_product_page']) { ?> <a
                                        href="<?php echo hikashop_contentLink('product&task=show&cid=' . $row->product_id . '&name=' . $row->alias . $this->url_itemid, $row); ?>"><?php } ?>
                                        <?php echo $row->product_name; ?>
                                        <?php if ($this->config->get('show_code')) { ?><span
                                            class="hikashop_product_code_cart"><?php echo $row->product_code; ?></span><?php } ?>
                                ...
                                <td class="hikashop_cart_module_product_quantity_value hikashop_cart_value">
                                    ...
                                    if ($this->element->cart_id == $session->cart_id && $this->params->get('from', 'display') != 'module') {
                                        if ($row->product_quantity_layout == 'show_select' || (empty($this->row->product_quantity_layout) && $this->config->get('product_quantity_display', 'show_default') == 'show_select')) {
                                            ...
                                            ?>
                                            <input id="hikashop_wishlist_quantity_<?php echo $row->cart_product_id; ?>"
                                                   type="text"
                                                   name="item[<?php echo $row->cart_product_id; ?>][cart_product_quantity]"
                                        ...
                                        if ($row->product_quantity_layout == 'show_select' || (empty($row->product_quantity_layout) && $this->config->get('product_quantity_display', 'show_default') == 'show_select')) {
                                            ...
                                            ?>
                                            <input id="hikashop_cart_quantity_<?php echo $row->cart_product_id; ?>"
                                                   type="text"
                                                   name="item[<?php echo $row->cart_product_id; ?>][cart_product_quantity]"
                                                   class="hikashop_product_quantity_field"
                                                   value="<?php echo $row->cart_product_quantity; ?>"
                                    ...
                                    if ($this->params->get('show_delete', 1) && $this->params->get('from', 'display') != 'module') {
                                        ...
                                        <div class="hikashop_cart_product_quantity_delete">
                                            <a href="<?php echo hikashop_completeLink('product&task=updatecart&product_id=' . $row->product_id . $this->url_itemid . '&quantity=0&return_url=' . urlencode(base64_encode(hikashop_currentURL('return_url')))); ?>"
                            ...
                            if ($this->params->get('show_cart_delete', 1)) {
                                ...
                                <td class="hikashop_cart_module_product_delete_value hikashop_cart_value">
                                    <a href="<?php echo hikashop_completeLink('product&task=updatecart&cart_type=' . $this->cart_type . '&cart_product_id=' . $row->cart_product_id . '&quantity=0&return_url=' . urlencode(base64_encode(urldecode($this->params->get('url'))))); ?>"
...
';
                ...
                if ($this->params->get('show_cart_quantity', 1)) {
                    ?>
                    <noscript>
                        <input type="submit" class="btn button" name="refresh"
