...
';
    ...
    function tab()
    {
        ...
        $config =& hikashop_config();
        $this->assignRef('config', $config);
        $selectparentlisting = $this->params->get('selectparentlisting', array());
        $list_rows=array();
        $list_pageInfo=array();
        foreach ($selectparentlisting as $cat_id) {
            $this->params->get('selectparentlisting', array($cat_id));
            $module = hikashop_get('helper.module');
            $module->initialize($this);
            ...
            $pageInfo->elements->page = count($rows);
            $list_rows[]=$rows;
            $list_pageInfo[]=$pageInfo;

        }

        $this->assignRef('list_rows', $list_rows);
        $this->assignRef('list_pageInfo', $list_pageInfo);
