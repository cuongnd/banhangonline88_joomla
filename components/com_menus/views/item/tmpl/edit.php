...
$doc->addScript( '/components/com_menus/assets/js/view_items_edit.js');
...
?>
	<script type="text/javascript">
		jQuery(document).ready(function ($) {
			$(".admin.com_menus.view-item.layout-edit").view_items_edit({
				enable_check_params:<?php echo json_encode(MenusHelper::ENABLE_CHECK_PARAMS) ?>,
				enable_check_select_category:<?php echo json_encode(MenusHelper::ENABLE_CHECK_SELECT_CATEGORY) ?>,
				task_js:"<?php echo $task_js ?>"
			});
		});
	</script>
<?php
