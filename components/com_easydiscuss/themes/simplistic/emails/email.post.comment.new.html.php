...
?>
<b><?php echo $commentAuthor; ?></b> <?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_COMMENTED' );?> <b><?php echo $postTitle; ?></b>
<br />
<hr style="clear:both;margin:10px 0 15px;padding:0;border:0;border-top:1px solid #ddd" />
<img src="<?php echo $commentAuthorAvatar; ?>" width="80" alt="<?php echo $commentAuthorAvatar; ?>" style="width:80px;height:80px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;float:left;margin:0 15px 0 0" />
