...
?>
<b><?php echo $replyAuthor; ?></b> <?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_HAS_REPLIED_TO_DISCUSSION' );?> <b><?php echo $postTitle; ?></b> <?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_IT_IS_PENDING_MODERATION');?>.
<br />
