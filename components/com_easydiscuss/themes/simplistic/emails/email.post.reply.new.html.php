...
<div class="discuss-attachments mv-15">
	...
	<?php foreach( $attachments as $attachment ) { ?>
		<li class="attachment-item thumbnail thumbnail-small attachment-<?php echo $attachment->attachmentType; ?>" id="attachment-<?php echo $attachment->id;?>" data-attachment-item>
