...
?>
<b><?php echo JText::sprintf( 'COM_EASYDISCUSS_EMAILTEMPLATE_LIKES_POST' , $authorName ); ?></b>
<br />
<hr style="clear:both;margin:10px 0 15px;padding:0;border:0;border-top:1px solid #ddd" />
<img src="<?php echo $authorAvatar; ?>" width="80" alt="<?php echo $authorName; ?>" style="width:80px;height:80px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;float:left;margin:0 15px 0 0" />
