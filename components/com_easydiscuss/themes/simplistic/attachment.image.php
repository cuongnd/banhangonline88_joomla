...
<?php if( $isEmail ){ ?>
	...
	<div class="caption">
		<a style="color:#477fda" class="attachment-image-link" title="<?php echo $this->escape( $attachment->title );?>" href="<?php echo DiscussRouter::getRoutedURL( 'index.php?option=com_easydiscuss&controller=attachment&task=displayFile&tmpl=component&id=' . $attachment->id, false, true ); ?>"><?php echo $attachment->title;?></a>
	</div>
