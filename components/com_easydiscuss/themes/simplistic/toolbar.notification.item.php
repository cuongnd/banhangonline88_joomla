...
<?php if( $notifications ){ ?>
	...
	<li class="item type-<?php echo $notification->type;?> new notificationItem">
		<?php if( !$notification->component || $notification->component  == 'com_easydiscuss' || empty( $notification->component ) ){ ?>
			<a href="<?php echo DiscussRouter::_( $notification->permalink , false );?>#<?php echo $notification->type;?>-<?php echo $notification->cid;?>">
		<?php } else { ?>
			<a href="<?php echo $notification->permalink;?>">
		<?php } ?>
	...
	<?php } ?>
<?php } else { ?>
	<li class="item dis-none notificationItem">
