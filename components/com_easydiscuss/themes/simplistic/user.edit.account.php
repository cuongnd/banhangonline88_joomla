...
<div class="tab-item user-post">
	<div class="control-group">
		<div class="input-label"><?php echo JText::_('COM_EASYDISCUSS_PROFILE_USERNAME'); ?></div>
		<b class=""><i class="icon-user"></i> <?php echo $user->username; ?></b>
	</div>
	<div class="control-group">
		<div class="input-label"><?php echo JText::_('COM_EASYDISCUSS_PROFILE_EMAIL'); ?></div>
		<b class=""><i class="icon-envelope-alt"></i> <?php echo $user->email; ?></b>
	</div>
