...
class EasySocialControllerEvents extends EasySocialController
{
    ...
    public function getEvents()
    {
        ...
        $options = array('state' => SOCIAL_STATE_PUBLISHED, 'ordering' => $ordering, 'type' => $this->my->isSiteAdmin() ? 'all' : array(SOCIAL_EVENT_TYPE_PUBLIC, SOCIAL_EVENT_TYPE_PRIVATE), 'featured' => FD::config()->get('events.listing.includefeatured') ? 'all' : false);
    ...
    public function saveStep()
    {
        ...
        // Clear the session as soon as the event is created
        $stepSession->delete();
