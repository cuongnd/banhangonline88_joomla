...
class EasyBlogCompiler
{
	...
	public function compile( $minify=false )
	{
		...
		foreach ($files as $file)
		{
			...
			// easyblog.static.js
			// easyblog.static.min.js
			// easyblog.optimized.js
			// easyblog.optimized.min.js
			// easyblog-3.9.12345.static.js
			// easyblog-3.9.12345.static.min.js
			// easyblog-3.9.12345.optimized.js
			// easyblog-3.9.12345.optimized.min.js
			if (preg_match('/easyblog[\.\-].+\.js/', $file)) continue;
		...
		$options = array(
			"static"    => EASYBLOG_SCRIPTS . '/easyblog-' . $this->version . '.static',
			"optimized" => EASYBLOG_SCRIPTS . '/easyblog-' . $this->version . '.optimized',
			"resources" => EASYBLOG_MEDIA   . '/resources/default-' . $this->version,
			"minify"    => $minify
		);
	...
	public function getDefaultResources()
	{
		...
		return array(
			"id"   => "default",
			"path" => EASYBLOG_RESOURCES     . $file,
			"uri"  => EASYBLOG_RESOURCES_URI . $file,
