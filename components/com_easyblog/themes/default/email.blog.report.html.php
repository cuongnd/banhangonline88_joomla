			...
			<tr>
				<td width="100">
					<span style="display:block;margin: 0px auto 20px;border:1px solid #f5f5f5;width:64px;padding:3px;border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff">
						<a href="<?php echo $reporterLink;?>"><img src="<?php echo $reporterAvatar;?>" alt="<?php echo $reporterName;?>" style="border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff" width="64" height="64"/><?php echo $reporterName; ?></a>
					</span>
				</td>
				<td>
					<table style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
						...
						<tr>
							<td>
								<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_ON' );?> <?php echo $reportDate;?>
							</td>
						</tr>
						<tr>
							<td>
							<?php echo $reason; ?>
								...
								">
									...
									<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_VIEW_REPORTED_POST' );?>
								</a>
							</td>
						</tr>
