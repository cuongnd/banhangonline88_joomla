...
<form class="cmform" name="partner_form" method="post" action="<?php echo JRoute::_('index.php', false); ?>">
	...
	<input type="submit" name="submit" value="<?php echo JText::_('COM_CMGROUPBUYING_PARTNER_CHECK_BUTTON'); ?>" />
</form>
<?php
...
?>
	...
	<form class="cmform" name="partner_form" method="post" action="<?php echo JRoute::_('index.php', false); ?>">
		...
		<input type="submit" name="submit" value="<?php echo JText::_('COM_CMGROUPBUYING_PARTNER_SET_EXCHANGED_BUTTON'); ?>" />
		<?php elseif ($coupon['coupon_status'] == 2): ?>
		<input type="submit" name="submit" value="<?php echo JText::_('COM_CMGROUPBUYING_PARTNER_SET_WAITING_BUTTON'); ?>" />
		<?php endif; ?>
	</form>
	<br/>
	<table class="order_detail_table">
		...
		<tr>
			<td class="title"><?php echo JText::_('COM_CMGROUPBUYING_ORDER_DEAL_NAME'); ?></td>
			<td>
				<?php echo $order['deal_name']; ?>
			</td>
		</tr>
		<tr>
			<td class="title"><?php echo JText::_('COM_CMGROUPBUYING_ORDER_OPTION_NAME'); ?></td>
			<td>
		...
		<tr>
			<td class="title"><?php echo JText::_('COM_CMGROUPBUYING_ORDER_TRANSACTION_INFO'); ?></td>
			<td>
			<?php
...
<?php else: ?>
	...
	<form class="cmform" id="partner_filter_form" name="partner_filter_form" method="post" action="<?php echo JRoute::_('index.php', false); ?>">
		<input type="hidden" name="option" value="com_cmgroupbuying" />
		<input type="hidden" name="view" value="partner" />
	...
	<?php else: ?>
		<table class="cmtable">
			<tr>
				<th><?php echo JText::_('COM_CMGROUPBUYING_COUPON_CODE'); ?></th>
				<th><?php echo JText::_('COM_CMGROUPBUYING_ORDER_ID'); ?></th>
				<th><?php echo JText::_('COM_CMGROUPBUYING_ORDER_DEAL_NAME'); ?></th>
				<th><?php echo JText::_('COM_CMGROUPBUYING_COUPON_STATUS'); ?></th>
			<?php
			$count = 1;
			...
			?>
				<td class="align_center">
					<form class="cmform" name="coupon_code_<?php echo $coupon['coupon_code']; ?>" method="post" action="<?php echo JRoute::_('index.php', false); ?>">
						<input type="hidden" name="option" value="com_cmgroupbuying" />
						<input type="hidden" name="view" value="partner" />
						<input type="hidden" name="coupon_code" value="<?php echo $coupon['coupon_code']; ?>" />
					</form>
				...
				<td class="align_center"><?php echo $coupon['order_id']; ?></td>
				<td class="align_center">
					<?php
