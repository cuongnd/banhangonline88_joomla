...
<div class="all_deal_section">
	...
	<form action="<?php echo JRoute::_('index.php', false); ?>" method="get" class="form-horizontal">
		<div class="control-group">
			<label class="control-label" for="keyword"><?php echo JText::_('COM_CMGROUPBUYING_SEARCH_KEYWORD'); ?></label>
			<div class="controls">
				<input type="text" id="keyword" name="keyword" placeholder="Keyword" value="<?php echo $keyword; ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="location_id"><?php echo JText::_('COM_CMGROUPBUYING_SEARCH_LOCATION'); ?></label>
			<div class="controls">
				<?php echo JHTML::_('select.genericList', $locationList, 'location_id', '' , 'id', 'name', $locationId); ?>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="category_id"><?php echo JText::_('COM_CMGROUPBUYING_SEARCH_CATEGORY'); ?></label>
			<div class="controls">
...
{
?>
		<div class="thumbnails item-list">
		<?php
			$i = 1;
