...
class CMGroupBuyingViewAllDeals extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$pageNav = JModelLegacy::getInstance('Deal', 'CMGroupBuyingModel')->getPagination(null, false, false, false, null, null, $locationString);
		$this->assignRef('pageNav', $pageNav);

		$pageTitle = JFactory::getDocument()->getTitle();
		$this->assignRef('pageTitle', $pageTitle);

		$noDeal = JText::_('COM_CMGROUPBUYING_ALL_DEALS_NO_DEAL');
