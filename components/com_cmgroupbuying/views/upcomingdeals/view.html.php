...
class CMGroupBuyingViewUpcomingDeals extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$deals = JModelLegacy::getInstance('Deal', 'CMGroupBuyingModel')->getLimit(false, true, false, null, null, $locationString);
		$this->assignRef('deals', $deals);

		$pageNav = JModelLegacy::getInstance('Deal', 'CMGroupBuyingModel')->getPagination(null, false, true, false, null, null, $locationString);
		$this->assignRef('pageNav', $pageNav);

		$pageTitle = JFactory::getDocument()->getTitle();
		$this->assignRef('pageTitle', $pageTitle); 

		$noDeal = JText::_('COM_CMGROUPBUYING_UPCOMING_DEALS_NO_DEAL');
