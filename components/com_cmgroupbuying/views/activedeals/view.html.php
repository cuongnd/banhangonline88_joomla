...
class CMGroupBuyingViewActiveDeals extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		//getLimit($active = true, $upcoming = false, $expired = false, $categoryId = null, $locationString = null, $rss = false, $orderBy = 'ordering ASC', $published = true)
		...
		$pageNav = JModelLegacy::getInstance('Deal', 'CMGroupBuyingModel')->getPagination(null, true, false, false, null, null, $locationString);
		$this->assignRef('pageNav', $pageNav);

		$pageTitle = JFactory::getDocument()->getTitle();
		$this->assignRef('pageTitle', $pageTitle); 

		$noDeal = JText::_('COM_CMGROUPBUYING_ACTIVE_DEALS_NO_DEAL');
