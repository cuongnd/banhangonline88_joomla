...
class CMGroupBuyingViewCategoryBrowsing extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$categories = JModelLegacy::getInstance('Category', 'CMGroupBuyingModel')
			->getPublishedCategories('geotargeting, deal_map_latitude, deal_map_longitude, jquery_loading');
		...
		$pageTitle = JText::_('COM_CMGROUPBUYING_CATEGORY_BROWSING_PAGE_TITLE');
