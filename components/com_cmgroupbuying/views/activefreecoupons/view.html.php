...
class CMGroupBuyingViewActiveFreeCoupons extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$coupons = JModelLegacy::getInstance('FreeCoupon', 'CMGroupBuyingModel')->getLimit($locationString, 'active');
		$this->assignRef('coupons', $coupons);

		$pageNav = JModelLegacy::getInstance('FreeCoupon', 'CMGroupBuyingModel')->getPagination(null, $locationString, 'active');
		...
		$this->_layout = "activefreecoupons";
		parent::display($tpl);
	}
}