...
class CMGroupBuyingViewFreeCoupons extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$coupons = JModelLegacy::getInstance('FreeCoupon', 'CMGroupBuyingModel')->getLimit($locationString);
		$this->assignRef('coupons', $coupons);

		$pageNav = JModelLegacy::getInstance('FreeCoupon', 'CMGroupBuyingModel')->getPagination(null, $locationString);
