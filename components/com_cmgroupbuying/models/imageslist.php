 ...
 * @since 1.5
 */
class CMGroupBuyingModelImagesList extends JModelLegacy
{
	...
	function getList()
	{
		...
		if (strlen($current) > 0) {
			$basePath = COM_CMGROUPBUYING_PARTNER_BASE.'/'.$current;
		}
		else {
			$basePath = COM_CMGROUPBUYING_PARTNER_BASE;
		}

		$mediaBase = str_replace(DS, '/', COM_CMGROUPBUYING_PARTNER_BASE.'/');
