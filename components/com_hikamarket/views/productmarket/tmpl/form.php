    ...
    <div id="hikamarket_product_edition_header"
        ...
        if (!empty($this->product)) {
            ...
            <h3><img src="<?php echo $image_url; ?>" alt=""
                     style="vertical-align:middle;margin-right:5px;"/><?php echo $this->product->product_name; ?></h3>
        ...
        <table class="hikam_blocks">
                ...
                <td class="hikam_block_r">
                    <dl class="hikam_options">
                        <?php if (hikamarket::acl('product/edit/name')) { ?>
                            ...
                            <dd class="hikamarket_product_name"><input type="text" name="data[product][product_name]"
                        ...
                        if (hikamarket::acl('product/edit/code')) { ?>
                            <dt class="hikamarket_product_code"><label><?php echo JText::_('PRODUCT_CODE'); ?></label>
                            </dt>
                            <dd class="hikamarket_product_code"><input type="text" name="data[product][product_code]"
                        ...
                        if (hikamarket::level(1) && $this->vendor->vendor_id == 1 && hikamarket::acl('product/subvendor') && hikamarket::acl('product/edit/vendor')) {
                            ?>
                            <dt class="hikamarket_product_vendor"><label><?php echo JText::_('HIKA_VENDOR'); ?></label>
                            </dt>
            ...
            if (!isset($this->product->product_type) || in_array($this->product->product_type, array('main', 'waiting_approval'))) {
                    ...
                    <td colspan="2">
                        <dl class="hikam_options">
                            ...
                            if (hikamarket::acl('product/edit/pagetitle')) { ?>
                                ...
                                <dd class="hikamarket_product_pagetitle"><input type="text" class="fullrow" size="45"
                            ...
                            if (hikamarket::acl('product/edit/metadescription')) { ?>
                                ...
                                <dd class="hikamarket_product_metadescription"><textarea id="product_meta_description"
                            ...
                            if (hikamarket::acl('product/edit/keywords')) { ?>
                                ...
                                <dd class="hikamarket_product_keywords"><textarea id="product_keywords" class="fullrow"
                                                                                  cols="35" rows="2"
                            ...
                            if (hikamarket::acl('product/edit/canonical')) { ?>
                                ...
                                <dd class="hikamarket_product_canonical"><input type="text" class="fullrow" size="45"
                            ...
                            if (hikamarket::acl('product/edit/tags')) {
                                ...
                                if (!empty($tagsHelper) && $tagsHelper->isCompatible()) { ?>
                                    <dt class="hikamarket_product_tags"><label><?php echo JText::_('JTAG'); ?></label>
                                    </dt>
                ...
                if (hikashop_level(1) && hikamarket::acl('product/edit/options')) { ?>
                    <dt class="hikamarket_product_options"><label><?php echo JText::_('OPTIONS'); ?></label>
                    </dt>
                ...
                <td colspan="2">
                    ...
                    <dl class="hikam_options">
                        ...
                        if (hikamarket::acl('product/edit/price')) { ?>
                            ...
                            <dd class="hikamarket_product_price">
                                <div class="hika_production_price_note"><?php echo JText::_('HIKA_PRODUCTION_PRICE_NOTE') ?></div>
                                <?php
                        ...
                        if (@$this->product->product_type != 'variant' && hikamarket::acl('product/edit/msrp')) {
                            ...
                            <dt class="hikamarket_product_msrp"><label><?php echo JText::_('PRODUCT_MSRP'); ?></label>
                            </dt>
                            <dd class="hikamarket_product_msrp">
                                <div class="hika_production_price_msrp"><?php echo JText::_('HIKA_PRODUCTION_PRICE_MSRP') ?></div>
                        ...
                        if (hikamarket::acl('product/edit/warehouse')) { ?>
                            <dt class="hikamarket_product_warehouse"><label><?php echo JText::_('WAREHOUSE'); ?></label>
                            </dt>
							...
							<span class="add-on"><?php
                                ...
                                ?></span>
                                    ...
                                    <input size="10" type="text" name="data[product][product_length]"
                                           value="<?php echo $this->escape(@$this->product->product_length); ?>"/><br/>
                    ...
                    <dl class="hikam_options">
                        ...
                        if (hikamarket::acl('product/edit/acl') && hikashop_level(2)) { ?>
                            <dt class="hikamarket_product_acl"><label><?php echo JText::_('ACCESS_LEVEL'); ?></label>
                            </dt>
