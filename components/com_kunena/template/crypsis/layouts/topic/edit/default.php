			...
			<div class="row-fluid column-row">
				<div class="span12 column-item">
					<fieldset>
						...
						<?php  
			            $login =  '<a class="btn-link" href="index.php?option=com_easysocial&view=login"> ' . JText::_('JLOGIN') . '</a>';
			            $register =  ' ' . JText::_('COM_KUNENA_LOGIN_OR') . ' <a class="btn-link" href="index.php?com_easysocial&view=registration">' . JText::_('JREGISTER') . '</a>';
