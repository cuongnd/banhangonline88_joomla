...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		<span><i class="symbol-icon fa fa-home"></i> 
	...
	<div class="width50 floatleft">
		...
		<span><i class="symbol-icon fa fa-truck"></i>
		...
		<a class="details btn btn-gray" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
