...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	...
	<td class="vm-cart-item-quantity" ><?php
		   ...
		   <input type="text"
			...
			<button type="submit" class="vmicon vm2-add_quantity_cart" name="updatecart.<?php echo $pkey ?>" title="<?php echo  vmText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" ><i class="fa fa-refresh"></i></button>

			<button type="submit" class="vmicon vm2-remove_from_cart" name="delete.<?php echo $pkey ?>" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" ><i class="fa fa-remove"></i></button>
	</td>
...
<tr class="sectiontableentry1 vmtotal-amount">
	<td colspan="4" align="right" class="amount-text"><?php echo vmText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
...
<tr class="sectiontableentry1" style="vertical-align:top;">
	<?php if (!$this->cart->automaticSelectedShipment) { ?>
		<td colspan="4" class="some-product-info" style="align:left;vertical-align:top;">
			<?php
...
<tr class="sectiontableentry2 vmtotal-amount">
	<td colspan="4" align="right" class="amount-text"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
