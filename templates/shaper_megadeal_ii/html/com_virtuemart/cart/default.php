...
<div id="cart-view" class="cart-view">
	<div class="custom-box-shadow">
		...
		<?php echo shopFunctionsF::getLoginForm ($this->cart, FALSE,$uri); ?>
	</div><!-- /.custom-box-shadow -->

	<?php if ($this->allowChangeShopper){ // This displays the form to change the current shopper ?>
		<div class="custom-box-shadow change-shoper">
	...
	<form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		<div class="custom-box-shadow vm-fieldset-pricelist-wrapper table-responsive">
			<p class="title"><?php echo vmText::_('COM_PRICELIST-WRAPPER'); ?></p>
			<?php
