...
class HelixFeatureFooter {
	...
	public function onPosition()
	{
		...
		if( $this->helix->Param('showcp', 1) ) {
			$back_link = date('Y').' <a href="http://vinagecko.com">VinaGecko.com</a>';
			echo '<span class="copyright">' . str_ireplace('{VinaGecko.com}',$back_link, $this->helix->Param('copyright')) . '</span>';
		}
