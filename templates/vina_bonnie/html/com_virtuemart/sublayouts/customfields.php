...
if (!empty($product->customfieldsSorted[$position])) {
	...
	<div class="<?php echo $class?>">
		...
		<div class="product-fields-title-wrapper"><span class="product-fields-title"><span class="red-validate">*</span><strong><?php echo vmText::_ ($field->custom_title); ?></strong></span>
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			?><div class="product-field product-field-type-<?php echo $field->field_type ?>">
				<?php if (!$customTitle and $field->custom_title != $custom_title and $field->show_title) { ?>
					<span class="product-fields-title-wrapper"><span class="product-fields-title"><span class="red-validate">*</span><strong><?php echo vmText::_ ($field->custom_title); ?></strong></span>
						<?php if ($field->custom_tip) {
