...
class JTabledomain extends JTable
{
	...
	public function __construct(JDatabaseDriver $db)
	{
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_domain.article'));
		JTableObserverdomainhistory::createObserver($this, array('typeAlias' => 'com_domain.article'));
	...
	protected function _getAssetName()
	{
		...
		return 'com_domain.article.' . (int) $this->$k;
	}
	 ...
	 * @param   integer  $id     The id (optional) of the domain.
	 *
	 * @return  integer
	 *
	 * @since   11.1
	...
	public function check()
	{
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_domain_WARNING_PROVIDE_VALID_NAME'));
		...
		if (!$this->id)
		{
			...
			if (!$this->getRules())
			{
				$rules = $this->getDefaultAssetValues('com_domain');
				$this->setRules($rules);
			}
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('domain', 'JTable', array('dbo' => $this->getDbo()));
