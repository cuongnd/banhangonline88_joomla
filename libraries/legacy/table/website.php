...
class JTablewebsite extends JTable
{
	...
	public function __construct(JDatabaseDriver $db)
	{
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_website.article'));
		JTableObserverwebsitehistory::createObserver($this, array('typeAlias' => 'com_website.article'));
	...
	protected function _getAssetName()
	{
		...
		return 'com_website.article.' . (int) $this->$k;
	}
	...
	public function check()
	{
		...
		if (!$this->id)
		{
			...
			if (!$this->getRules())
			{
				$rules = $this->getDefaultAssetValues('com_website');
				$this->setRules($rules);
			}
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('website', 'JTable', array('dbo' => $this->getDbo()));
