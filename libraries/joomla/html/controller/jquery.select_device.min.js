//huong dan su dung // jQuery Plugin for SprFlat admin select_device // Control options and basic function of select_device // version 1,28.02.2013 // by SuggeElson www.suggeelson.com (function ($){// here we go! $.select_device=function (element,options){// plugin's default options
        var defaults = {
    ...
    $.fn.select_device = function (options) {
        ...
        return this.each(function () {
            ...
            if (undefined == $(this).data('select_device')) {
                ...
                $(this).data('select_device',plugin)}})}})(jQuery);