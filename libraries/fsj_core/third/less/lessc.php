...
if (!class_exists("fsj_lessc"))
{
	class fsj_lessc {
		...
		protected function injectVariables($args) {
			$this->pushEnv();
			$parser = new fsj_lessc_parser($this, __METHOD__);
		...
		protected function makeParser($name) {
			$parser = new fsj_lessc_parser($this, $name);
		...
		protected function newFormatter() {
			$className = "fsj_lessc_formatter_lessjs";
			if (!empty($this->formatterName)) {
				if (!is_string($this->formatterName))
					return $this->formatterName;
				$className = "fsj_lessc_formatter_$this->formatterName";
			}
...
// syntax tree
if (!class_exists("fsj_lessc_parser"))
{
	class fsj_lessc_parser {
		...
		public function __construct($lessc, $sourceName = null) {
			...
			if (!self::$operatorString) {
				self::$operatorString =
					'('.implode('|', array_map(array('fsj_lessc', 'preg_quote'),
							array_keys(self::$precedence))).')';

				$commentSingle = fsj_lessc::preg_quote(self::$commentSingle);
				$commentMultiLeft = fsj_lessc::preg_quote(self::$commentMultiLeft);
				$commentMultiRight = fsj_lessc::preg_quote(self::$commentMultiRight);
		...
		protected function isDirective($dirname, $directives) {
			...
			$pattern = implode("|",
				array_map(array("fsj_lessc", "preg_quote"), $directives));
		...
		protected function expressionList(&$exps) {
			...
			$exps = fsj_lessc::compressList($values, ' ');
			return true;
		}
		...
		public function propertyValue(&$value, $keyName = null) {
			...
			$value = fsj_lessc::compressList($values, ', ');
			return true;
		}
		...
		protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
			...
			$stop = array("'", '"', "@{", $end);
			$stop = array_map(array("fsj_lessc", "preg_quote"), $stop);
		...
		protected function literal($what, $eatWhitespace = null) {
			...
			if (!isset(self::$literalCache[$what])) {
				self::$literalCache[$what] = fsj_lessc::preg_quote($what);
			}
		...
		protected function to($what, &$out, $until = false, $allowNewline = false) {
			...
			if (!$this->match('('.$validChars.'*?)'.fsj_lessc::preg_quote($what), $m, !$until)) return false;
...
if (!class_exists("fsj_lessc_formatter_classic"))
{
	class fsj_lessc_formatter_classic {
		public $indentChar = "  ";
...
if (!class_exists("fsj_lessc_formatter_compressed"))
{
	class fsj_lessc_formatter_compressed extends fsj_lessc_formatter_classic {
...
if (!class_exists("fsj_lessc_formatter_lessjs"))
{
	class fsj_lessc_formatter_lessjs extends fsj_lessc_formatter_classic {
		public $disableSingle = true;
